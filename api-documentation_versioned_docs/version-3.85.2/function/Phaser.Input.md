...
> Source: [src/input/CreateInteractiveObject.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/CreateInteractiveObject.js#L7)  
Since: 3.0.0
...
> Source: [src/input/CreatePixelPerfectHandler.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/CreatePixelPerfectHandler.js#L7)  
Since: 3.10.0
...
> Source: [src/input/InputPluginCache.js#L19](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/InputPluginCache.js#L19)  
Since: 3.10.0
...
**Returns:** [Phaser.Types.Input.InputPluginContainer](../typedef/Phaser.Types.Input.md#InputPluginContainer) - The input plugin object.


> Source: [src/input/InputPluginCache.js#L40](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/InputPluginCache.js#L40)  
Since: 3.10.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| target | [Phaser.Input.InputPlugin](../class/Phaser.Input.InputPlugin.md) | No | The target InputPlugin to install the plugins into. |


> Source: [src/input/InputPluginCache.js#L56](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/InputPluginCache.js#L56)  
Since: 3.10.0
...
> Source: [src/input/InputPluginCache.js#L85](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/InputPluginCache.js#L85)  
Since: 3.10.0
...
> Source: [src/input/keyboard/combo/AdvanceKeyCombo.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/combo/AdvanceKeyCombo.js#L7)  
Since: 3.0.0
...
> Source: [src/input/keyboard/combo/ProcessKeyCombo.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/combo/ProcessKeyCombo.js#L9)  
Since: 3.0.0
...
> Source: [src/input/keyboard/combo/ResetKeyCombo.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/combo/ResetKeyCombo.js#L7)  
Since: 3.0.0
...
> Source: [src/input/keyboard/keys/DownDuration.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/keys/DownDuration.js#L7)  
Since: 3.0.0
...
> Source: [src/input/keyboard/keys/JustDown.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/keys/JustDown.js#L7)  
Since: 3.0.0
...
> Source: [src/input/keyboard/keys/JustUp.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/keys/JustUp.js#L7)  
Since: 3.0.0
...
> Source: [src/input/keyboard/keys/UpDuration.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/keys/UpDuration.js#L7)  
Since: 3.0.0
