---
visibility: public
slug: function/tilemaps
title: Phaser.Tilemaps

seoTitle: Phaser.Tilemaps
seoDescription: Phaser v3.85.2 Documentation for Phaser.Tilemaps
ogImage: 
---
...
| layer | [Phaser.Tilemaps.LayerData](../class/Phaser.Tilemaps.LayerData.md) | No | The Tilemap Layer to act upon. |


> Source: [src/tilemaps/components/CalculateFacesAt.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/CalculateFacesAt.js#L9)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/CalculateFacesWithin.js#L10](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/CalculateFacesWithin.js#L10)  
Since: 3.0.0
...
| layer | [Phaser.Tilemaps.LayerData](../class/Phaser.Tilemaps.LayerData.md) | No | The Tilemap Layer to check against. |
...
> Source: [src/tilemaps/components/CheckIsoBounds.js#L11](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/CheckIsoBounds.js#L11)  
Since: 3.50.0
...
> Source: [src/tilemaps/components/Copy.js#L12](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/Copy.js#L12)  
Since: 3.0.0
...
| spriteConfig | [Phaser.Types.GameObjects.Sprite.SpriteConfig](../typedef/Phaser.Types.GameObjects.Sprite.md#SpriteConfig) | No | The config object to pass into the Sprite creator (i.e. scene.make.sprite). |
| scene | [Phaser.Scene](../class/Phaser.Scene.md) | No | The Scene to create the Sprites within. |
| camera | [Phaser.Cameras.Scene2D.Camera](../class/Phaser.Cameras.Scene2D.Camera.md) | No | The Camera to use when determining the world XY |
| layer | [Phaser.Tilemaps.LayerData](../class/Phaser.Tilemaps.LayerData.md) | No | The Tilemap Layer to act upon. |
...
> Source: [src/tilemaps/components/CreateFromTiles.js#L11](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/CreateFromTiles.js#L11)  
Since: 3.0.0
...
| ---- | ---- | -------- | ----------- |
| layer | [Phaser.Tilemaps.LayerData](../class/Phaser.Tilemaps.LayerData.md) | No | The Tilemap Layer to act upon. |
| camera | [Phaser.Cameras.Scene2D.Camera](../class/Phaser.Cameras.Scene2D.Camera.md) | No | The Camera to run the cull check against. |


**Returns:** [Phaser.Geom.Rectangle](../class/Phaser.Geom.Rectangle.md) - A rectangle containing the culled bounds. If you wish to retain this object, clone it, as it's recycled internally.


> Source: [src/tilemaps/components/CullBounds.js#L13](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/CullBounds.js#L13)  
Since: 3.50.0
...
> Source: [src/tilemaps/components/CullTiles.js#L10](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/CullTiles.js#L10)  
Since: 3.50.0
...
| height | number | No | How many tiles tall from the `tileY` index the area will be. |
| recalculateFaces | boolean | No | `true` if the faces data should be recalculated. |
| layer | [Phaser.Tilemaps.LayerData](../class/Phaser.Tilemaps.LayerData.md) | No | The tile layer to use. If not given the current layer is used. |


> Source: [src/tilemaps/components/Fill.js#L11](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/Fill.js#L11)  
Since: 3.0.0
...
| width | number | No | How many tiles wide from the `tileX` index the area will be. |
| height | number | No | How many tiles tall from the `tileY` index the area will be. |
| filteringOptions | [Phaser.Types.Tilemaps.FilteringOptions](../typedef/Phaser.Types.Tilemaps.md#FilteringOptions) | No | Optional filters to apply when getting the tiles. |
| layer | [Phaser.Tilemaps.LayerData](../class/Phaser.Tilemaps.LayerData.md) | No | The Tilemap Layer to act upon. |


**Returns:** Array.\<[Phaser.Tilemaps.Tile](../class/Phaser.Tilemaps.Tile.md)> - The filtered array of Tiles.


> Source: [src/tilemaps/components/FilterTiles.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/FilterTiles.js#L9)  
Since: 3.0.0
...
**Returns:** [Phaser.Tilemaps.Tile](../class/Phaser.Tilemaps.Tile.md) - The first (or n skipped) tile with the matching index.


> Source: [src/tilemaps/components/FindByIndex.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/FindByIndex.js#L7)  
Since: 3.0.0
...
**Returns:** [Phaser.Tilemaps.Tile](../class/Phaser.Tilemaps.Tile.md) - A Tile that matches the search, or null if no Tile found


> Source: [src/tilemaps/components/FindTile.js#L19](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/FindTile.js#L19)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/ForEachTile.js#L17](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/ForEachTile.js#L17)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/GetCullTilesFunction.js#L14](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/GetCullTilesFunction.js#L14)  
Since: 3.50.0
...
> Source: [src/tilemaps/components/GetTileAt.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/GetTileAt.js#L9)  
Since: 3.0.0
...
| nonNull | boolean | No | For empty tiles, return a Tile object with an index of -1 instead of null. |
| camera | [Phaser.Cameras.Scene2D.Camera](../class/Phaser.Cameras.Scene2D.Camera.md) | No | The Camera to use when calculating the tile index from the world values. |
| layer | [Phaser.Tilemaps.LayerData](../class/Phaser.Tilemaps.LayerData.md) | No | The Tilemap Layer to act upon. |
...
> Source: [src/tilemaps/components/GetTileAtWorldXY.js#L12](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/GetTileAtWorldXY.js#L12)  
Since: 3.0.0
...
**Returns:** Array.\<[Phaser.Math.Vector2](../class/Phaser.Math.Vector2.md)> - An array of Vector2s corresponding to the world XY location of each tile corner.


> Source: [src/tilemaps/components/GetTileCorners.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/GetTileCorners.js#L9)  
Since: 3.60.0
...
> Source: [src/tilemaps/components/GetTileCornersFunction.js#L12](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/GetTileCornersFunction.js#L12)  
Since: 3.60.0
...
**Returns:** Array.\<[Phaser.Tilemaps.Tile](../class/Phaser.Tilemaps.Tile.md)> - Array of Tile objects.


> Source: [src/tilemaps/components/GetTilesWithin.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/GetTilesWithin.js#L9)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/GetTilesWithinShape.js#L22](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/GetTilesWithinShape.js#L22)  
Since: 3.0.0
...
| filteringOptions | [Phaser.Types.Tilemaps.FilteringOptions](../typedef/Phaser.Types.Tilemaps.md#FilteringOptions) | No | Optional filters to apply when getting the tiles. |
| camera | [Phaser.Cameras.Scene2D.Camera](../class/Phaser.Cameras.Scene2D.Camera.md) | No | The Camera to use when factoring in which tiles to return. |
| layer | [Phaser.Tilemaps.LayerData](../class/Phaser.Tilemaps.LayerData.md) | No | The Tilemap Layer to act upon. |
...
> Source: [src/tilemaps/components/GetTilesWithinWorldXY.js#L13](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/GetTilesWithinWorldXY.js#L13)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/GetTileToWorldXFunction.js#L11](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/GetTileToWorldXFunction.js#L11)  
Since: 3.50.0
...
> Source: [src/tilemaps/components/GetTileToWorldXYFunction.js#L14](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/GetTileToWorldXYFunction.js#L14)  
Since: 3.50.0
...
> Source: [src/tilemaps/components/GetTileToWorldYFunction.js#L12](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/GetTileToWorldYFunction.js#L12)  
Since: 3.50.0
...
> Source: [src/tilemaps/components/GetWorldToTileXFunction.js#L11](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/GetWorldToTileXFunction.js#L11)  
Since: 3.50.0
...
> Source: [src/tilemaps/components/GetWorldToTileXYFunction.js#L14](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/GetWorldToTileXYFunction.js#L14)  
Since: 3.50.0
...
> Source: [src/tilemaps/components/GetWorldToTileYFunction.js#L12](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/GetWorldToTileYFunction.js#L12)  
Since: 3.50.0
...
> Source: [src/tilemaps/components/HasTileAt.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/HasTileAt.js#L9)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/HasTileAtWorldXY.js#L12](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/HasTileAtWorldXY.js#L12)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/HexagonalCullBounds.js#L10](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/HexagonalCullBounds.js#L10)  
Since: 3.50.0
...
> Source: [src/tilemaps/components/HexagonalCullTiles.js#L10](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/HexagonalCullTiles.js#L10)  
Since: 3.50.0
...
> Source: [src/tilemaps/components/HexagonalGetTileCorners.js#L12](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/HexagonalGetTileCorners.js#L12)  
Since: 3.60.0
...
| tileX | number | No | The x coordinate, in tiles, not pixels. |
| tileY | number | No | The y coordinate, in tiles, not pixels. |
| point | [Phaser.Math.Vector2](../class/Phaser.Math.Vector2.md) | No | A Vector2 to store the coordinates in. If not given a new Vector2 is created. |
| camera | [Phaser.Cameras.Scene2D.Camera](../class/Phaser.Cameras.Scene2D.Camera.md) | No | The Camera to use when calculating the tile index from the world values. |
| layer | [Phaser.Tilemaps.LayerData](../class/Phaser.Tilemaps.LayerData.md) | No | The Tilemap Layer to act upon. |


**Returns:** [Phaser.Math.Vector2](../class/Phaser.Math.Vector2.md) - The XY location in world coordinates.


> Source: [src/tilemaps/components/HexagonalTileToWorldXY.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/HexagonalTileToWorldXY.js#L9)  
Since: 3.50.0
...
**Returns:** [Phaser.Math.Vector2](../class/Phaser.Math.Vector2.md) - The XY location in tile units.


> Source: [src/tilemaps/components/HexagonalWorldToTileXY.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/HexagonalWorldToTileXY.js#L9)  
Since: 3.50.0
...
> Source: [src/tilemaps/components/IsInLayerBounds.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/IsInLayerBounds.js#L7)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/IsometricCullTiles.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/IsometricCullTiles.js#L9)  
Since: 3.50.0
...
> Source: [src/tilemaps/components/IsometricTileToWorldXY.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/IsometricTileToWorldXY.js#L9)  
Since: 3.50.0
...
> Source: [src/tilemaps/components/IsometricWorldToTileXY.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/IsometricWorldToTileXY.js#L9)  
Since: 3.50.0
...
**Returns:** [Phaser.Tilemaps.Tile](../class/Phaser.Tilemaps.Tile.md) - The Tile object that was created or added to this map.


> Source: [src/tilemaps/components/PutTileAt.js#L12](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/PutTileAt.js#L12)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/PutTileAtWorldXY.js#L12](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/PutTileAtWorldXY.js#L12)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/PutTilesAt.js#L10](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/PutTilesAt.js#L10)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/Randomize.js#L10](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/Randomize.js#L10)  
Since: 3.0.0
...
**Returns:** [Phaser.Tilemaps.Tile](../class/Phaser.Tilemaps.Tile.md) - The Tile object that was removed.


> Source: [src/tilemaps/components/RemoveTileAt.js#L11](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/RemoveTileAt.js#L11)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/RemoveTileAtWorldXY.js#L12](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/RemoveTileAtWorldXY.js#L12)  
Since: 3.0.0
...
| styleConfig | [Phaser.Types.Tilemaps.DebugStyleOptions](../typedef/Phaser.Types.Tilemaps.md#DebugStyleOptions) | No | An object specifying the colors to use for the debug drawing. |
| layer | [Phaser.Tilemaps.LayerData](../class/Phaser.Tilemaps.LayerData.md) | No | The Tilemap Layer to act upon. |


> Source: [src/tilemaps/components/RenderDebug.js#L14](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/RenderDebug.js#L14)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/ReplaceByIndex.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/ReplaceByIndex.js#L9)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/RunCull.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/RunCull.js#L7)  
Since: 3.50.0
...
> Source: [src/tilemaps/components/SetCollision.js#L11](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/SetCollision.js#L11)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/SetCollisionBetween.js#L11](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/SetCollisionBetween.js#L11)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/SetCollisionByExclusion.js#L11](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/SetCollisionByExclusion.js#L11)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/SetCollisionByProperty.js#L11](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/SetCollisionByProperty.js#L11)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/SetCollisionFromCollisionGroup.js#L10](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/SetCollisionFromCollisionGroup.js#L10)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/SetLayerCollisionIndex.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/SetLayerCollisionIndex.js#L7)  
Since: 3.0.0
...
| name | type | optional | default | description |
| ---- | ---- | -------- | ------- | ----------- |
| tile | [Phaser.Tilemaps.Tile](../class/Phaser.Tilemaps.Tile.md) | No |  | The Tile to set the collision on. |
| collides | boolean | Yes | true | Should the tile index collide or not? |


> Source: [src/tilemaps/components/SetTileCollision.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/SetTileCollision.js#L7)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/SetTileIndexCallback.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/SetTileIndexCallback.js#L7)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/SetTileLocationCallback.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/SetTileLocationCallback.js#L9)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/Shuffle.js#L10](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/Shuffle.js#L10)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/StaggeredCullBounds.js#L10](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/StaggeredCullBounds.js#L10)  
Since: 3.50.0
...
> Source: [src/tilemaps/components/StaggeredCullTiles.js#L10](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/StaggeredCullTiles.js#L10)  
Since: 3.50.0
...
> Source: [src/tilemaps/components/StaggeredTileToWorldXY.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/StaggeredTileToWorldXY.js#L9)  
Since: 3.50.0
...
> Source: [src/tilemaps/components/StaggeredTileToWorldY.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/StaggeredTileToWorldY.js#L7)  
Since: 3.50.0
...
> Source: [src/tilemaps/components/StaggeredWorldToTileXY.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/StaggeredWorldToTileXY.js#L9)  
Since: 3.50.0
...
> Source: [src/tilemaps/components/StaggeredWorldToTileY.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/StaggeredWorldToTileY.js#L7)  
Since: 3.50.0
...
> Source: [src/tilemaps/components/SwapByIndex.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/SwapByIndex.js#L9)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/TileToWorldX.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/TileToWorldX.js#L7)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/TileToWorldXY.js#L11](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/TileToWorldXY.js#L11)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/TileToWorldY.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/TileToWorldY.js#L7)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/WeightedRandomize.js#L10](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/WeightedRandomize.js#L10)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/WorldToTileX.js#L12](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/WorldToTileX.js#L12)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/WorldToTileXY.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/WorldToTileXY.js#L9)  
Since: 3.0.0
...
> Source: [src/tilemaps/components/WorldToTileY.js#L12](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/components/WorldToTileY.js#L12)  
Since: 3.0.0
...
> Source: [src/tilemaps/parsers/FromOrientationString.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/parsers/FromOrientationString.js#L9)  
Since: 3.50.0
...
> Source: [src/tilemaps/parsers/Parse.js#L13](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/parsers/Parse.js#L13)  
Since: 3.0.0
...
> Source: [src/tilemaps/parsers/Parse2DArray.js#L12](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/parsers/Parse2DArray.js#L12)  
Since: 3.0.0
...
> Source: [src/tilemaps/parsers/ParseCSV.js#L10](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/parsers/ParseCSV.js#L10)  
Since: 3.0.0
...
**Returns:** Array.\<[Phaser.Tilemaps.LayerData](../class/Phaser.Tilemaps.LayerData.md)> - - An array of LayerData objects, one for each entry in
json.layers with the type 'tilelayer'.


> Source: [src/tilemaps/parsers/impact/ParseTileLayers.js#L10](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/parsers/impact/ParseTileLayers.js#L10)  
Since: 3.0.0
...
> Source: [src/tilemaps/parsers/impact/ParseTilesets.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/parsers/impact/ParseTilesets.js#L9)  
Since: 3.0.0
...
**Returns:** [Phaser.Tilemaps.MapData](../class/Phaser.Tilemaps.MapData.md) - The created MapData object, or `null` if the data can't be parsed.


> Source: [src/tilemaps/parsers/impact/ParseWeltmeister.js#L12](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/parsers/impact/ParseWeltmeister.js#L12)  
Since: 3.0.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| mapData | [Phaser.Tilemaps.MapData](../class/Phaser.Tilemaps.MapData.md) | No | The Map Data object. |


> Source: [src/tilemaps/parsers/tiled/AssignTileProperties.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/parsers/tiled/AssignTileProperties.js#L9)  
Since: 3.0.0
...
> Source: [src/tilemaps/parsers/tiled/Base64Decode.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/parsers/tiled/Base64Decode.js#L7)  
Since: 3.0.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| mapData | [Phaser.Tilemaps.MapData](../class/Phaser.Tilemaps.MapData.md) \| [Phaser.Tilemaps.Tilemap](../class/Phaser.Tilemaps.Tilemap.md) | No | The Map Data object. |


**Returns:** array - An array of Tileset objects.


> Source: [src/tilemaps/parsers/tiled/BuildTilesetIndex.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/parsers/tiled/BuildTilesetIndex.js#L9)  
Since: 3.0.0
...
> Source: [src/tilemaps/parsers/tiled/CreateGroupLayer.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/parsers/tiled/CreateGroupLayer.js#L9)  
Since: 3.21.0
...
[http://docs.mapeditor.org/en/latest/reference/tmx-map-format/](http://docs.mapeditor.org/en/latest/reference/tmx-map-format/)
...
**Returns:** [Phaser.Types.Tilemaps.GIDData](../typedef/Phaser.Types.Tilemaps.md#GIDData) - The GID Data.


> Source: [src/tilemaps/parsers/tiled/ParseGID.js#L11](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/parsers/tiled/ParseGID.js#L11)  
Since: 3.0.0
...
> Source: [src/tilemaps/parsers/tiled/ParseImageLayers.js#L10](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/parsers/tiled/ParseImageLayers.js#L10)  
Since: 3.0.0
...
> Source: [src/tilemaps/parsers/tiled/ParseJSONTiled.js#L19](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/parsers/tiled/ParseJSONTiled.js#L19)  
Since: 3.0.0
...
> Source: [src/tilemaps/parsers/tiled/ParseObject.js#L14](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/parsers/tiled/ParseObject.js#L14)  
Since: 3.0.0
...
> Source: [src/tilemaps/parsers/tiled/ParseObjectLayers.js#L12](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/parsers/tiled/ParseObjectLayers.js#L12)  
Since: 3.0.0
...
> Source: [src/tilemaps/parsers/tiled/ParseTileLayers.js#L16](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/parsers/tiled/ParseTileLayers.js#L16)  
Since: 3.0.0
...
> Source: [src/tilemaps/parsers/tiled/ParseTilesets.js#L12](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/parsers/tiled/ParseTilesets.js#L12)  
Since: 3.0.0
...
See [https://doc.mapeditor.org/en/latest/manual/using-wang-tiles/](https://doc.mapeditor.org/en/latest/manual/using-wang-tiles/) for more information.
...
> Source: [src/tilemaps/parsers/tiled/ParseWangsets.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/parsers/tiled/ParseWangsets.js#L7)  
Since: 3.53.0
...
> Source: [src/tilemaps/ParseToTilemap.js#L12](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/ParseToTilemap.js#L12)  
Since: 3.0.0
