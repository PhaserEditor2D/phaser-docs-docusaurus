...
seoDescription: Phaser v3.85.2 Documentation for Phaser.Types.Input
ogImage: 
---
...
> Source: [src/input/typedefs/EventData.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/typedefs/EventData.js#L7)  
Since: 3.15.1
...
**Member of**: Phaser.Types.Input
> Source: [src/input/typedefs/HitAreaCallback.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/typedefs/HitAreaCallback.js#L1)  
Since: 3.0.0
...
| hitAreaCallback | [Phaser.Types.Input.HitAreaCallback](../typedef/Phaser.Types.Input.md#HitAreaCallback) | Yes |  | The callback that determines if the pointer is within the Hit Area shape or not. |
...
**Member of**: Phaser.Types.Input
> Source: [src/input/typedefs/InputConfiguration.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/typedefs/InputConfiguration.js#L1)  
Since: 3.0.0
...
**Member of**: Phaser.Types.Input
> Source: [src/input/typedefs/InputPluginContainer.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/typedefs/InputPluginContainer.js#L1)  
Since: 3.0.0
...
| target | [Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md) | No | An optional drop target for a draggable Interactive Object. |
| camera | [Phaser.Cameras.Scene2D.Camera](../class/Phaser.Cameras.Scene2D.Camera.md) | No | The most recent Camera to be tested against this Interactive Object. |
...
| hitAreaDebug | [Phaser.GameObjects.Shape](../class/Phaser.GameObjects.Shape.md) | No | If this Interactive Object has been enabled for debug, via `InputPlugin.enableDebug` then this property holds its debug shape. |
...
| dragState | 0 \| 1 | 2 | No | The current drag state of this Interactive Object. 0 = Not being dragged, 1 = being checked for drag, or 2 = being actively dragged. |
...
**Member of**: Phaser.Types.Input
> Source: [src/input/typedefs/InteractiveObject.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/typedefs/InteractiveObject.js#L1)  
Since: 3.0.0
