...
seoDescription: Phaser v3.85.2 Documentation for Phaser.Types.GameObjects.Text
ogImage: 
---
...
> Source: [src/gameobjects/text/typedefs/GetTextSizeObject.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/gameobjects/text/typedefs/GetTextSizeObject.js#L1)  
Since: 3.0.0
...
| padding | [Phaser.Types.GameObjects.Text.TextPadding](../typedef/Phaser.Types.GameObjects.Text.md#TextPadding) | Yes | A Text Padding object. |

**Type**: object

**Member of**: Phaser.Types.GameObjects.Text
> Source: [src/gameobjects/text/typedefs/TextConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/gameobjects/text/typedefs/TextConfig.js#L1)  
Since: 3.0.0
...
**Member of**: Phaser.Types.GameObjects.Text
> Source: [src/gameobjects/text/typedefs/TextMetrics.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/gameobjects/text/typedefs/TextMetrics.js#L1)  
Since: 3.0.0
...
**Member of**: Phaser.Types.GameObjects.Text
> Source: [src/gameobjects/text/typedefs/TextPadding.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/gameobjects/text/typedefs/TextPadding.js#L1)  
Since: 3.18.0
...
**Member of**: Phaser.Types.GameObjects.Text
> Source: [src/gameobjects/text/typedefs/TextShadow.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/gameobjects/text/typedefs/TextShadow.js#L1)  
Since: 3.0.0
...
| color | string \| CanvasGradient | CanvasPattern | Yes | "'#fff'" | The color the Text is drawn in. Given as a CSS string color such as `#fff` or `rgb()`. |
| stroke | string \| CanvasGradient | CanvasPattern | Yes | "'#fff'" | The color used to stroke the Text if the `strokeThickness` property is greater than zero. |
| strokeThickness | number | Yes | 0 | The thickness of the stroke around the Text. Set to zero for no stroke. |
| shadow | [Phaser.Types.GameObjects.Text.TextShadow](../typedef/Phaser.Types.GameObjects.Text.md#TextShadow) | Yes |  | The Text shadow configuration object. |
| padding | [Phaser.Types.GameObjects.Text.TextPadding](../typedef/Phaser.Types.GameObjects.Text.md#TextPadding) | Yes |  | A Text Padding object. |
...
| wordWrap | [Phaser.Types.GameObjects.Text.TextWordWrap](../typedef/Phaser.Types.GameObjects.Text.md#TextWordWrap) | Yes |  | The Text Word wrap configuration object. |
| metrics | [Phaser.Types.GameObjects.Text.TextMetrics](../typedef/Phaser.Types.GameObjects.Text.md#TextMetrics) | Yes |  | A Text Metrics object. Use this to avoid expensive font size calculations in text heavy games. |
| lineSpacing | number | Yes |  | The amount to add to the font height to achieve the overall line height. |

**Type**: object

**Member of**: Phaser.Types.GameObjects.Text
> Source: [src/gameobjects/text/typedefs/TextStyle.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/gameobjects/text/typedefs/TextStyle.js#L1)  
Since: 3.0.0
...
**Member of**: Phaser.Types.GameObjects.Text
> Source: [src/gameobjects/text/typedefs/TextWordWrap.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/gameobjects/text/typedefs/TextWordWrap.js#L1)  
Since: 3.0.0
