...
seoDescription: Phaser v3.85.2 Documentation for Phaser.Types.Tilemaps
ogImage: 
---
...
| scene | [Phaser.Scene](../class/Phaser.Scene.md) | Yes | A Scene reference, passed to the Game Objects constructors. |
| container | [Phaser.GameObjects.Container](../class/Phaser.GameObjects.Container.md) | Yes | Optional Container to which the Game Objects are added. |
| key | string \| [Phaser.Textures.Texture](../class/Phaser.Textures.Texture.md) | Yes | Optional key of a Texture to be used, as stored in the Texture Manager, or a Texture instance. If omitted, the object's gid's tileset key is used if available. |
...
> Source: [src/tilemaps/typedefs/CreateFromObjectLayerConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/typedefs/CreateFromObjectLayerConfig.js#L1)  
Since: 3.50.0
...
**Member of**: Phaser.Types.Tilemaps
> Source: [src/tilemaps/typedefs/CreateFromObjectsClassTypeConstructor.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/typedefs/CreateFromObjectsClassTypeConstructor.js#L1)  
Since: 3.60.0
...
| ---- | ---- | -------- | ------- | ----------- |
| styleConfig.tileColor | [Phaser.Display.Color](../namespace/Phaser.Display.Color.md) | Yes | "blue" | Color to use for drawing a filled rectangle at non-colliding tile locations. If set to null, non-colliding tiles will not be drawn. |
| styleConfig.collidingTileColor | [Phaser.Display.Color](../namespace/Phaser.Display.Color.md) | Yes | "orange" | Color to use for drawing a filled rectangle at colliding tile locations. If set to null, colliding tiles will not be drawn. |
| styleConfig.faceColor | [Phaser.Display.Color](../namespace/Phaser.Display.Color.md) | Yes | "grey" | Color to use for drawing a line at interesting tile faces. If set to null, interesting tile faces will not be drawn. |

**Type**: object

**Member of**: Phaser.Types.Tilemaps
> Source: [src/tilemaps/typedefs/DebugStyleOptions.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/typedefs/DebugStyleOptions.js#L1)  
Since: 3.0.0
...
**Member of**: Phaser.Types.Tilemaps
> Source: [src/tilemaps/typedefs/FilteringOptions.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/typedefs/FilteringOptions.js#L1)  
Since: 3.0.0
...
**Member of**: Phaser.Types.Tilemaps
> Source: [src/tilemaps/typedefs/GIDData.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/typedefs/GIDData.js#L1)  
Since: 3.0.0
...
| tilemapLayer | [Phaser.Tilemaps.TilemapLayer](../class/Phaser.Tilemaps.TilemapLayer.md) | Yes |  | A reference to the Tilemap layer that owns this data. |

**Type**: object

**Member of**: Phaser.Types.Tilemaps
> Source: [src/tilemaps/typedefs/LayerDataConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/typedefs/LayerDataConfig.js#L1)  
Since: 3.0.0
...
| orientation | string \| [Phaser.Tilemaps.Orientation](../namespace/Phaser.Tilemaps.Orientation.md) | Yes |  | The orientation of the map data (i.e. orthogonal, isometric, hexagonal), default 'orthogonal'. |
...
| layers | Array.\<[Phaser.Tilemaps.LayerData](../class/Phaser.Tilemaps.LayerData.md)> | Yes |  | The layers of the tilemap. |
...
| tilesets | Array.\<[Phaser.Tilemaps.Tileset](../class/Phaser.Tilemaps.Tileset.md)> | Yes |  | The tilesets the map uses. |
...
**Member of**: Phaser.Types.Tilemaps
> Source: [src/tilemaps/typedefs/MapDataConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/typedefs/MapDataConfig.js#L1)  
Since: 3.0.0
...
**Member of**: Phaser.Types.Tilemaps
> Source: [src/tilemaps/typedefs/ObjectLayerConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/typedefs/ObjectLayerConfig.js#L1)  
Since: 3.0.0
...
| name | type | optional | default | description |
| ---- | ---- | -------- | ------- | ----------- |
| tileColor | [Phaser.Display.Color](../namespace/Phaser.Display.Color.md) \| number | null | Yes | "blue" | Color to use for drawing a filled rectangle at non-colliding tile locations. If set to null, non-colliding tiles will not be drawn. |
| collidingTileColor | [Phaser.Display.Color](../namespace/Phaser.Display.Color.md) \| number | null | Yes | "orange" | Color to use for drawing a filled rectangle at colliding tile locations. If set to null, colliding tiles will not be drawn. |
| faceColor | [Phaser.Display.Color](../namespace/Phaser.Display.Color.md) \| number | null | Yes | "grey" | Color to use for drawing a line at interesting tile faces. If set to null, interesting tile faces will not be drawn. |

**Type**: object

**Member of**: Phaser.Types.Tilemaps
> Source: [src/tilemaps/typedefs/StyleConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/typedefs/StyleConfig.js#L1)  
Since: 3.0.0
...
| polyline | Array.\<[Phaser.Types.Math.Vector2Like](../typedef/Phaser.Types.Math.md#Vector2Like)> | Yes | Only set if a polyline object. An array of objects corresponding to points, where each point has an `x` property and a `y` property. |
| polygon | Array.\<[Phaser.Types.Math.Vector2Like](../typedef/Phaser.Types.Math.md#Vector2Like)> | Yes | Only set if a polygon object. An array of objects corresponding to points, where each point has an `x` property and a `y` property. |
...
**Member of**: Phaser.Types.Tilemaps
> Source: [src/tilemaps/typedefs/TiledObject.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/typedefs/TiledObject.js#L1)  
Since: 3.0.0
...
**Member of**: Phaser.Types.Tilemaps
> Source: [src/tilemaps/typedefs/TilemapConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/typedefs/TilemapConfig.js#L1)  
Since: 3.0.0
