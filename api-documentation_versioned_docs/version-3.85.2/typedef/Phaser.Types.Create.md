...
seoDescription: Phaser v3.85.2 Documentation for Phaser.Types.Create
ogImage: 
---
...
> Source: [src/create/typedefs/GenerateTextureConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/create/typedefs/GenerateTextureConfig.js#L1)  
Since: 3.0.0
...
**Member of**: Phaser.Types.Create
> Source: [src/create/typedefs/GenerateTextureConfig.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/create/typedefs/GenerateTextureConfig.js#L9)  
Since: 3.0.0
...
**Member of**: Phaser.Types.Create
> Source: [src/create/typedefs/Palette.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/create/typedefs/Palette.js#L1)  
Since: 3.0.0
