---
visibility: public
slug: typedef/types-animations
title: Types.Animations
description: Phaser.Types.Animations
seoTitle: Types.Animations
seoDescription: Phaser v3.85.2 Documentation for Phaser.Types.Animations
ogImage: 
---
...
| frames | string \| Array.\<[Phaser.Types.Animations.AnimationFrame](../typedef/Phaser.Types.Animations.md#AnimationFrame)> | Yes |  | Either a string, in which case it will use all frames from a texture with the matching key, or an array of Animation Frame configuration objects. |
...
| showOnStart | boolean | Yes | false | Should sprite.visible = true when the animation starts to play? This happens _after_ any delay, if set. |
...
> Source: [src/animations/typedefs/Animation.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/typedefs/Animation.js#L1)  
Since: 3.0.0
...
**Member of**: Phaser.Types.Animations
> Source: [src/animations/typedefs/AnimationFrame.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/typedefs/AnimationFrame.js#L1)  
Since: 3.0.0
...
| outputArray | Array.\<[Phaser.Types.Animations.AnimationFrame](../typedef/Phaser.Types.Animations.md#AnimationFrame)> | Yes | "[]" | The array to append the created configuration objects to. |
...
**Member of**: Phaser.Types.Animations
> Source: [src/animations/typedefs/GenerateFrameNames.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/typedefs/GenerateFrameNames.js#L1)  
Since: 3.0.0
...
| outputArray | Array.\<[Phaser.Types.Animations.AnimationFrame](../typedef/Phaser.Types.Animations.md#AnimationFrame)> | Yes | "[]" | An array to concatenate the output onto. |
| frames | boolean \| Array.\<number> | Yes | false | A custom sequence of frames. |

**Type**: object

**Member of**: Phaser.Types.Animations
> Source: [src/animations/typedefs/GenerateFrameNumbers.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/typedefs/GenerateFrameNumbers.js#L1)  
Since: 3.0.0
...
| frames | Array.\<[Phaser.Types.Animations.JSONAnimationFrame](../typedef/Phaser.Types.Animations.md#JSONAnimationFrame)> | No | An array of the AnimationFrame objects inside this Animation. |
...
**Member of**: Phaser.Types.Animations
> Source: [src/animations/typedefs/JSONAnimation.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/typedefs/JSONAnimation.js#L1)  
Since: 3.0.0
...
**Member of**: Phaser.Types.Animations
> Source: [src/animations/typedefs/JSONAnimationFrame.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/typedefs/JSONAnimationFrame.js#L1)  
Since: 3.0.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| anims | Array.\<[Phaser.Types.Animations.JSONAnimation](../typedef/Phaser.Types.Animations.md#JSONAnimation)> | No | An array of all Animations added to the Animation Manager. |
| globalTimeScale | number | No | The global time scale of the Animation Manager. |

**Type**: object

**Member of**: Phaser.Types.Animations
> Source: [src/animations/typedefs/JSONAnimations.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/typedefs/JSONAnimations.js#L1)  
Since: 3.0.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| key | string \| [Phaser.Animations.Animation](../class/Phaser.Animations.Animation.md) | No | The string-based key of the animation to play, or an Animation instance. |
| frameRate | number | Yes | The frame rate of playback in frames per second (default 24 if duration is null) |
| duration | number | Yes | How long the animation should play for in milliseconds. If not given its derived from frameRate. |
...
**Member of**: Phaser.Types.Animations
> Source: [src/animations/typedefs/PlayAnimationConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/typedefs/PlayAnimationConfig.js#L1)  
Since: 3.50.0
