---
visibility: public
slug: typedef/types-gameobjects
title: Types.GameObjects
description: Phaser.Types.GameObjects
seoTitle: Types.GameObjects
seoDescription: Phaser v3.85.2 Documentation for Phaser.Types.GameObjects
ogImage: 
---
...
> Source: [src/gameobjects/typedefs/DecomposeMatrixResults.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/gameobjects/typedefs/DecomposeMatrixResults.js#L1)  
Since: 3.60.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| vertex1 | [Phaser.Types.GameObjects.Vertex](../typedef/Phaser.Types.GameObjects.md#Vertex) | No | The first face vertex. |
| vertex2 | [Phaser.Types.GameObjects.Vertex](../typedef/Phaser.Types.GameObjects.md#Vertex) | No | The second face vertex. |
| vertex3 | [Phaser.Types.GameObjects.Vertex](../typedef/Phaser.Types.GameObjects.md#Vertex) | No | The third face vertex. |
| isCounterClockwise | boolean | No | Are the vertices counter-clockwise? |

**Type**: object

**Member of**: Phaser.Types.GameObjects
> Source: [src/gameobjects/typedefs/Face.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/gameobjects/typedefs/Face.js#L1)  
Since: 3.50.0
...
**Member of**: Phaser.Types.GameObjects
> Source: [src/gameobjects/typedefs/GameObjectConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/gameobjects/typedefs/GameObjectConfig.js#L1)  
Since: 3.0.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| camera | [Phaser.GameObjects.Components.TransformMatrix](../class/Phaser.GameObjects.Components.TransformMatrix.md) | No | The calculated Camera matrix. |
| sprite | [Phaser.GameObjects.Components.TransformMatrix](../class/Phaser.GameObjects.Components.TransformMatrix.md) | No | The calculated Sprite (Game Object) matrix. |
| calc | [Phaser.GameObjects.Components.TransformMatrix](../class/Phaser.GameObjects.Components.TransformMatrix.md) | No | The calculated results matrix, factoring all others in. |

**Type**: object

**Member of**: Phaser.Types.GameObjects
> Source: [src/gameobjects/typedefs/GetCalcMatrixResults.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/gameobjects/typedefs/GetCalcMatrixResults.js#L1)  
Since: 3.50.0
...
**Member of**: Phaser.Types.GameObjects
> Source: [src/gameobjects/typedefs/JSONGameObject.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/gameobjects/typedefs/JSONGameObject.js#L1)  
Since: 3.0.0
...
**Member of**: Phaser.Types.GameObjects
> Source: [src/gameobjects/typedefs/Vertex.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/gameobjects/typedefs/Vertex.js#L1)  
Since: 3.50.0
