...
seoDescription: Phaser v3.85.2 Documentation for Phaser.Types.Renderer.WebGL
ogImage: 
---
...
> Source: [src/renderer/webgl/typedefs/RenderTargetConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/renderer/webgl/typedefs/RenderTargetConfig.js#L1)  
Since: 3.50.0
...
**Member of**: Phaser.Types.Renderer.WebGL
> Source: [src/renderer/webgl/typedefs/WebGLConst.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/renderer/webgl/typedefs/WebGLConst.js#L1)  
Since: 3.50.0
...
| location | number \| [Phaser.Renderer.WebGL.Wrappers.WebGLAttribLocationWrapper](../class/Phaser.Renderer.WebGL.Wrappers.WebGLAttribLocationWrapper.md) | No | You should set this to `-1` by default. The pipeline will set it on boot. |

**Type**: object

**Member of**: Phaser.Types.Renderer.WebGL
> Source: [src/renderer/webgl/typedefs/WebGLPipelineAttribute.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/renderer/webgl/typedefs/WebGLPipelineAttribute.js#L1)  
Since: 3.50.0
...
| name | string | No |  | The name of the attribute as defined in the vertex shader. |
| size | number | No |  | The number of components in the attribute, i.e. 1 for a float, 2 for a vec2, 3 for a vec3, etc. |
| type | [Phaser.Types.Renderer.WebGL.WebGLConst](../typedef/Phaser.Types.Renderer.WebGL.md#WebGLConst) | No |  | The data type of the attribute, one of the `WEBGL_CONST` values, i.e. `WEBGL_CONST.FLOAT`, `WEBGL_CONST.UNSIGNED_BYTE`, etc. |
| normalized | boolean | Yes | false | Should the attribute data be normalized? |

**Type**: object

**Member of**: Phaser.Types.Renderer.WebGL
> Source: [src/renderer/webgl/typedefs/WebGLPipelineAttributeConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/renderer/webgl/typedefs/WebGLPipelineAttributeConfig.js#L1)  
Since: 3.50.0
...
| texture | Array.\<[Phaser.Renderer.WebGL.Wrappers.WebGLTextureWrapper](../class/Phaser.Renderer.WebGL.Wrappers.WebGLTextureWrapper.md)> | No | An array of WebGLTextureWrapper references used in this batch entry. |

**Type**: object

**Member of**: Phaser.Types.Renderer.WebGL
> Source: [src/renderer/webgl/typedefs/WebGLPipelineBatchEntry.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/renderer/webgl/typedefs/WebGLPipelineBatchEntry.js#L1)  
Since: 3.60.0
...
| name | type | optional | default | description |
| ---- | ---- | -------- | ------- | ----------- |
| game | [Phaser.Game](../class/Phaser.Game.md) | No |  | The Phaser.Game instance that owns this pipeline. |
...
| attributes | Array.\<[Phaser.Types.Renderer.WebGL.WebGLPipelineAttributeConfig](../typedef/Phaser.Types.Renderer.WebGL.md#WebGLPipelineAttributeConfig)> | Yes |  | An array of shader attribute data. All shaders bound to this pipeline must use the same attributes. |
| shaders | Array.\<[Phaser.Types.Renderer.WebGL.WebGLPipelineShaderConfig](../typedef/Phaser.Types.Renderer.WebGL.md#WebGLPipelineShaderConfig)> | Yes |  | An array of shaders, all of which are created for this one pipeline. Uses the `vertShader`, `fragShader`, `attributes` and `uniforms` properties of this object as defaults. |
...
| renderTarget | boolean \| number | Array.\<[Phaser.Types.Renderer.WebGL.RenderTargetConfig](../typedef/Phaser.Types.Renderer.WebGL.md#RenderTargetConfig)> | Yes |  | Create Render Targets for this pipeline. Can be a number, which determines the quantity, a boolean (sets quantity to 1), or an array of Render Target configuration objects. |
...
**Member of**: Phaser.Types.Renderer.WebGL
> Source: [src/renderer/webgl/typedefs/WebGLPipelineConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/renderer/webgl/typedefs/WebGLPipelineConfig.js#L1)  
Since: 3.50.0
...
**Member of**: Phaser.Types.Renderer.WebGL
> Source: [src/renderer/webgl/typedefs/WebGLPipelineShaderConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/renderer/webgl/typedefs/WebGLPipelineShaderConfig.js#L1)  
Since: 3.50.0
...
**Member of**: Phaser.Types.Renderer.WebGL
> Source: [src/renderer/webgl/typedefs/WebGLPipelineUniformsConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/renderer/webgl/typedefs/WebGLPipelineUniformsConfig.js#L1)  
Since: 3.55.1
...
**Member of**: Phaser.Types.Renderer.WebGL
> Source: [src/renderer/webgl/typedefs/WebGLTextureCompression.js#L1](https://github.com/phaserjs/phaser/blob/v3.85.2/src/renderer/webgl/typedefs/WebGLTextureCompression.js#L1)  
Since: 3.55.0
