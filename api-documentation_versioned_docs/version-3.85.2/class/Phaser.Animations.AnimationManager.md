...
seoDescription: Phaser v3.85.2 Documentation for Phaser.Animations.AnimationManager
ogImage: 
---
...
> Source: [src/animations/AnimationManager.js#L19](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L19)  
Since: 3.0.0
...
This map should be modified with the [#add](#add) and [#create](#create) methods of the Animation Manager.


**Access:** protected


> Source: [src/animations/AnimationManager.js#L79](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L79)  
Since: 3.0.0
...
> Source: [src/animations/AnimationManager.js#L47](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L47)  
Since: 3.0.0
...
> Source: [src/animations/AnimationManager.js#L67](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L67)  
Since: 3.0.0
...
### mixes: Phaser.Structs.Map.\<string, [Phaser.Animations.Animation](../class/Phaser.Animations.Animation.md)>
...
See the [#setMix](#setMix) method for more details.


> Source: [src/animations/AnimationManager.js#L91](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L91)  
Since: 3.50.0
...
> Source: [src/animations/AnimationManager.js#L112](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L112)  
Since: 3.0.0
...
> Source: [src/animations/AnimationManager.js#L102](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L102)  
Since: 3.0.0
...
> Source: [src/animations/AnimationManager.js#L57](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L57)  
Since: 3.0.0
...
| animation | [Phaser.Animations.Animation](../class/Phaser.Animations.Animation.md) | No | The Animation which should be added to the Animation Manager. |


**Returns:** [Phaser.Animations.AnimationManager](../class/Phaser.Animations.AnimationManager.md) - This Animation Manager.


**Fires:** [Phaser.Animations.Events#event:ADD_ANIMATION](../event/Phaser.Animations.Events.md#ADD_ANIMATION)


> Source: [src/animations/AnimationManager.js#L276](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L276)  
Since: 3.0.0
...
**Returns:** [Phaser.Animations.AnimationManager](../class/Phaser.Animations.AnimationManager.md) - `this`.
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| animA | string \| [Phaser.Animations.Animation](../class/Phaser.Animations.Animation.md) | No | The string-based key, or instance of, Animation A. |
| animB | string \| [Phaser.Animations.Animation](../class/Phaser.Animations.Animation.md) | No | The string-based key, or instance of, Animation B. |
...
> Source: [src/animations/AnimationManager.js#L138](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L138)  
Since: 3.50.0
...
> Source: [src/animations/AnimationManager.js#L124](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L124)  
Since: 3.0.0
...
> Source: [src/animations/AnimationManager.js#L492](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L492)  
Since: 3.0.0
...
| target | [Phaser.Animations.AnimationManager](../class/Phaser.Animations.AnimationManager.md) \| [Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md) | Yes | Create the animations on this target Sprite. If not given, they will be created globally in this Animation Manager. |
...
> Source: [src/animations/AnimationManager.js#L323](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L323)  
Since: 3.50.0
...
> Source: [src/animations/AnimationManager.js#L1045](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L1045)  
Since: 3.0.0
...
> Source: [src/animations/AnimationManager.js#L306](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L306)  
Since: 3.16.0
...
| name | type | optional | default | description |
| ---- | ---- | -------- | ------- | ----------- |
| data | string \| [Phaser.Types.Animations.JSONAnimations](../typedef/Phaser.Types.Animations.md#JSONAnimations) | [Phaser.Types.Animations.JSONAnimation](../typedef/Phaser.Types.Animations.md#JSONAnimation) | No |  | The JSON object to parse. |
...
**Returns:** Array.\<[Phaser.Animations.Animation](../class/Phaser.Animations.Animation.md)> - An array containing all of the Animation objects that were created as a result of this call.


> Source: [src/animations/AnimationManager.js#L540](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L540)  
Since: 3.0.0
...
> Source: [src/animations/AnimationManager.js#L589](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L589)  
Since: 3.0.0
...
> Source: [src/animations/AnimationManager.js#L689](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L689)  
Since: 3.0.0
...
**Returns:** [Phaser.Animations.Animation](../class/Phaser.Animations.Animation.md) - The Animation.


> Source: [src/animations/AnimationManager.js#L793](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L793)  
Since: 3.0.0
...
> Source: [src/animations/AnimationManager.js#L808](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L808)  
Since: 3.60.0
...
> Source: [src/animations/AnimationManager.js#L241](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L241)  
Since: 3.50.0
...
**Fires:** [Phaser.Animations.Events#event:PAUSE_ALL](../event/Phaser.Animations.Events.md#PAUSE_ALL)


> Source: [src/animations/AnimationManager.js#L848](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L848)  
Since: 3.0.0
...
| children | [Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md) \| Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> | No | An array of Game Objects to play the animation on. They must have an Animation Component. |


**Returns:** [Phaser.Animations.AnimationManager](../class/Phaser.Animations.AnimationManager.md) - This Animation Manager.


> Source: [src/animations/AnimationManager.js#L869](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L869)  
Since: 3.0.0
...
**Returns:** [Phaser.Animations.Animation](../class/Phaser.Animations.Animation.md) - The Animation instance that was removed from the Animation Manager.


**Fires:** [Phaser.Animations.Events#event:REMOVE_ANIMATION](../event/Phaser.Animations.Events.md#REMOVE_ANIMATION)


> Source: [src/animations/AnimationManager.js#L961](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L961)  
Since: 3.0.0
...
| ---- | ---- | -------- | ----------- |
| animA | string \| [Phaser.Animations.Animation](../class/Phaser.Animations.Animation.md) | No | The string-based key, or instance of, Animation A. |
| animB | string \| [Phaser.Animations.Animation](../class/Phaser.Animations.Animation.md) | Yes | The string-based key, or instance of, Animation B. If not given, all mixes for Animation A will be removed. |


**Returns:** [Phaser.Animations.AnimationManager](../class/Phaser.Animations.AnimationManager.md) - This Animation Manager.


> Source: [src/animations/AnimationManager.js#L191](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L191)  
Since: 3.50.0
...
**Fires:** [Phaser.Animations.Events#event:RESUME_ALL](../event/Phaser.Animations.Events.md#RESUME_ALL)


> Source: [src/animations/AnimationManager.js#L991](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L991)  
Since: 3.0.0
...
> Source: [src/animations/AnimationManager.js#L895](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L895)  
Since: 3.0.0
...
**Returns:** [Phaser.Types.Animations.JSONAnimations](../typedef/Phaser.Types.Animations.md#JSONAnimations) - The resulting JSONAnimations formatted object.


> Source: [src/animations/AnimationManager.js#L1012](https://github.com/phaserjs/phaser/blob/v3.85.2/src/animations/AnimationManager.js#L1012)  
Since: 3.0.0
