...
seoDescription: Phaser v3.85.2 Documentation for Phaser.Curves.MoveTo
ogImage: 
---
...
> Source: [src/curves/path/MoveTo.js#L10](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/path/MoveTo.js#L10)  
Since: 3.0.0
...
> Source: [src/curves/path/MoveTo.js#L29](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/path/MoveTo.js#L29)  
Since: 3.0.0
...
> Source: [src/curves/path/MoveTo.js#L39](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/path/MoveTo.js#L39)  
Since: 3.0.0
...
> Source: [src/curves/path/MoveTo.js#L100](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/path/MoveTo.js#L100)  
Since: 3.0.0
...
> Source: [src/curves/path/MoveTo.js#L49](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/path/MoveTo.js#L49)  
Since: 3.0.0
...
| out | [Phaser.Math.Vector2](../class/Phaser.Math.Vector2.md) | Yes | An optional vector in which to store the point. |


**Returns:** [Phaser.Math.Vector2](../class/Phaser.Math.Vector2.md) - The modified `out` vector, or a new `Vector2` if none was provided.


> Source: [src/curves/path/MoveTo.js#L69](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/path/MoveTo.js#L69)  
Since: 3.0.0
...
> Source: [src/curves/path/MoveTo.js#L87](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/path/MoveTo.js#L87)  
Since: 3.0.0
...
**Returns:** [Phaser.Types.Curves.JSONCurve](../typedef/Phaser.Types.Curves.md#JSONCurve) - A primitive object with the curve's type and only point.


> Source: [src/curves/path/MoveTo.js#L113](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/path/MoveTo.js#L113)  
Since: 3.0.0
