---
visibility: public
slug: class/curves-cubicbezier
title: CubicBezier
description: Phaser.Curves.CubicBezier
seoTitle: Phaser.Curves.CubicBezier
seoDescription: Phaser v3.85.2 Documentation for Phaser.Curves.CubicBezier
ogImage: 
---
...
| ---- | ---- | -------- | ----------- |
| p0 | [Phaser.Math.Vector2](../class/Phaser.Math.Vector2.md) \| Array.\<[Phaser.Math.Vector2](../class/Phaser.Math.Vector2.md)> | No | Start point, or an array of point pairs. |
| p1 | [Phaser.Math.Vector2](../class/Phaser.Math.Vector2.md) | No | Control Point 1. |
| p2 | [Phaser.Math.Vector2](../class/Phaser.Math.Vector2.md) | No | Control Point 2. |
| p3 | [Phaser.Math.Vector2](../class/Phaser.Math.Vector2.md) | No | End Point. |
...
> Source: [src/curves/CubicBezierCurve.js#L14](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/CubicBezierCurve.js#L14)  
Since: 3.0.0
...
> Source: [src/curves/CubicBezierCurve.js#L47](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/CubicBezierCurve.js#L47)  
Since: 3.0.0
...
### p1: [Phaser.Math.Vector2](../class/Phaser.Math.Vector2.md)
...
> Source: [src/curves/CubicBezierCurve.js#L56](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/CubicBezierCurve.js#L56)  
Since: 3.0.0
...
### p2: [Phaser.Math.Vector2](../class/Phaser.Math.Vector2.md)
...
> Source: [src/curves/CubicBezierCurve.js#L65](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/CubicBezierCurve.js#L65)  
Since: 3.0.0
...
### p3: [Phaser.Math.Vector2](../class/Phaser.Math.Vector2.md)
...
> Source: [src/curves/CubicBezierCurve.js#L74](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/CubicBezierCurve.js#L74)  
Since: 3.0.0
...
| ---- | ---- | -------- | ------- | ----------- |
| graphics | [Phaser.GameObjects.Graphics](../class/Phaser.GameObjects.Graphics.md) | No |  | The graphics object this curve should be drawn to. |
...
**Returns:** [Phaser.GameObjects.Graphics](../class/Phaser.GameObjects.Graphics.md) - The graphics object this curve was drawn to. Useful for method chaining.


> Source: [src/curves/CubicBezierCurve.js#L143](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/CubicBezierCurve.js#L143)  
Since: 3.0.0
...
> Source: [src/curves/CubicBezierCurve.js#L199](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/CubicBezierCurve.js#L199)  
Since: 3.0.0
...
> Source: [src/curves/CubicBezierCurve.js#L118](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/CubicBezierCurve.js#L118)  
Since: 3.0.0
...
> Source: [src/curves/CubicBezierCurve.js#L103](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/CubicBezierCurve.js#L103)  
Since: 3.0.0
...
> Source: [src/curves/CubicBezierCurve.js#L84](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/CubicBezierCurve.js#L84)  
Since: 3.0.0
...
**Returns:** [Phaser.Types.Curves.JSONCurve](../typedef/Phaser.Types.Curves.md#JSONCurve) - The JSON object containing this curve data.


> Source: [src/curves/CubicBezierCurve.js#L176](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/CubicBezierCurve.js#L176)  
Since: 3.0.0
