---
visibility: public
slug: class/tilemaps-tilemap
title: Tilemap
description: Phaser.Tilemaps.Tilemap
seoTitle: Phaser.Tilemaps.Tilemap
seoDescription: Phaser v3.85.2 Documentation for Phaser.Tilemaps.Tilemap
ogImage: 
---
...
| mapData | [Phaser.Tilemaps.MapData](../class/Phaser.Tilemaps.MapData.md) | No | A MapData instance containing Tilemap data. |
...
> Source: [src/tilemaps/Tilemap.js#L45](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L45)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L283](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L283)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L180](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L180)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L144](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L144)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L219](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L219)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L292](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L292)  
Since: 3.50.0
...
### imageCollections: Array.\<[Phaser.Tilemaps.ImageCollection](../class/Phaser.Tilemaps.ImageCollection.md)>
...
> Source: [src/tilemaps/Tilemap.js#L228](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L228)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L237](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L237)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L1583](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1583)  
Since: 3.0.0
...
### layers: Array.\<[Phaser.Tilemaps.LayerData](../class/Phaser.Tilemaps.LayerData.md)>
...
> Source: [src/tilemaps/Tilemap.js#L246](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L246)  
Since: 3.0.0
...
### objects: Array.\<[Phaser.Tilemaps.ObjectLayer](../class/Phaser.Tilemaps.ObjectLayer.md)>
...
> Source: [src/tilemaps/Tilemap.js#L274](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L274)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L153](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L153)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L198](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L198)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L162](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L162)  
Since: 3.12.0
...
> Source: [src/tilemaps/Tilemap.js#L108](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L108)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L125](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L125)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L255](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L255)  
Since: 3.60.0
...
> Source: [src/tilemaps/Tilemap.js#L265](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L265)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L115](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L115)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L189](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L189)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L135](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L135)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L210](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L210)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L304](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L304)  
Since: 3.50.0
...
**Returns:** [Phaser.Tilemaps.Tileset](../class/Phaser.Tilemaps.Tileset.md) - Returns the Tileset object that was created or updated, or null if it
failed.


> Source: [src/tilemaps/Tilemap.js#L370](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L370)  
Since: 3.0.0
...
| layer | string \| number | [Phaser.Tilemaps.TilemapLayer](../class/Phaser.Tilemaps.TilemapLayer.md) | Yes | The tile layer to use. If not given the current layer is used. |


**Returns:** [Phaser.Tilemaps.Tilemap](../class/Phaser.Tilemaps.Tilemap.md) - Returns this, or null if the layer given was invalid.


> Source: [src/tilemaps/Tilemap.js#L1729](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1729)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L1756](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1756)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L459](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L459)  
Since: 3.0.0
...
**Returns:** [Phaser.Tilemaps.TilemapLayer](../class/Phaser.Tilemaps.TilemapLayer.md) - Returns the new layer that was created, or `null` if it failed.


> Source: [src/tilemaps/Tilemap.js#L501](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L501)  
Since: 3.0.0
...
By default this method will convert Objects into [Phaser.GameObjects.Sprite](../class/Phaser.GameObjects.Sprite) instances, but you can override
...
any class type here, but it _must_ extend [Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject) as its base class.
...
class must have [setPosition](../namespace/Phaser.GameObjects.Components.Transform.md#setPosition) and
[setTexture](../namespace/Phaser.GameObjects.Components.Texture.md#setTexture) methods.
...
- on the Game Object's [data](../class/Phaser.GameObjects.GameObject.md#data) otherwise.
...
| config | [Phaser.Types.Tilemaps.CreateFromObjectLayerConfig](../typedef/Phaser.Types.Tilemaps.md#CreateFromObjectLayerConfig) \| Array.\<[Phaser.Types.Tilemaps.CreateFromObjectLayerConfig](../typedef/Phaser.Types.Tilemaps.md#CreateFromObjectLayerConfig)> | No |  | A CreateFromObjects configuration object, or an array of them. |
| useTileset | boolean | Yes | true | True if objects that set gids should also search the underlying tile for properties and data. |


**Returns:** Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> - An array containing the Game Objects that were created. Empty if invalid object layer, or no matching id/gid/name was found.


> Source: [src/tilemaps/Tilemap.js#L641](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L641)  
Since: 3.0.0
...
**Returns:** Array.\<[Phaser.GameObjects.Sprite](../class/Phaser.GameObjects.Sprite.md)> - Returns an array of Tiles, or null if the layer given was invalid.


> Source: [src/tilemaps/Tilemap.js#L925](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L925)  
Since: 3.0.0
...
**Returns:** [Phaser.Tilemaps.TilemapLayer](../class/Phaser.Tilemaps.TilemapLayer.md) - Returns the new layer was created, or null if it failed.


> Source: [src/tilemaps/Tilemap.js#L573](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L573)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L2707](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L2707)  
Since: 3.0.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| layer | string \| number | [Phaser.Tilemaps.TilemapLayer](../class/Phaser.Tilemaps.TilemapLayer.md) | Yes | The tile layer to be destroyed. |


**Returns:** [Phaser.Tilemaps.Tilemap](../class/Phaser.Tilemaps.Tilemap.md) - Returns this, or null if the layer given was invalid.


> Source: [src/tilemaps/Tilemap.js#L1826](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1826)  
Since: 3.17.0
...
> Source: [src/tilemaps/Tilemap.js#L970](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L970)  
Since: 3.0.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| objectLayer | [Phaser.Tilemaps.ObjectLayer](../class/Phaser.Tilemaps.ObjectLayer.md) \| string | No | The name of an object layer (from Tiled) or an ObjectLayer instance. |
...
**Returns:** Array.\<[Phaser.Types.Tilemaps.TiledObject](../typedef/Phaser.Types.Tilemaps.md#TiledObject)> - An array of object that match the search, or null if the objectLayer given was invalid.


> Source: [src/tilemaps/Tilemap.js#L1004](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1004)  
Since: 3.0.0
...
**Returns:** Array.\<[Phaser.Tilemaps.Tile](../class/Phaser.Tilemaps.Tile.md)> - Returns an array of Tiles, or null if the layer given was invalid.


> Source: [src/tilemaps/Tilemap.js#L1036](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1036)  
Since: 3.0.0
...
**Returns:** [Phaser.Tilemaps.Tile](../class/Phaser.Tilemaps.Tile.md) - Returns a Tiles, or null if the layer given was invalid.


> Source: [src/tilemaps/Tilemap.js#L1067](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1067)  
Since: 3.0.0
...
**Returns:** [Phaser.Types.Tilemaps.TiledObject](../typedef/Phaser.Types.Tilemaps.md#TiledObject) - An object that matches the search, or null if no object found.


> Source: [src/tilemaps/Tilemap.js#L1094](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1094)  
Since: 3.0.0
...
| height | number | Yes | How many tiles tall from the `tileY` index the area will be. |
| filteringOptions | [Phaser.Types.Tilemaps.FilteringOptions](../typedef/Phaser.Types.Tilemaps.md#FilteringOptions) | Yes | Optional filters to apply when getting the tiles. |
| layer | string \| number | [Phaser.Tilemaps.TilemapLayer](../class/Phaser.Tilemaps.TilemapLayer.md) | Yes | The Tile layer to run the search on. If not provided will use the current layer. |


**Returns:** [Phaser.Tilemaps.Tile](../class/Phaser.Tilemaps.Tile.md) - Returns a Tiles, or null if the layer given was invalid.


> Source: [src/tilemaps/Tilemap.js#L1126](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1126)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L1155](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1155)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L1186](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1186)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L1201](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1201)  
Since: 3.21.0
...
> Source: [src/tilemaps/Tilemap.js#L1222](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1222)  
Since: 3.0.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| layer | string \| number | [Phaser.Tilemaps.TilemapLayer](../class/Phaser.Tilemaps.TilemapLayer.md) | Yes | The name of the layer from Tiled, the index of the layer in the map or Tilemap Layer. If not given will default to the maps current layer index. |


**Returns:** [Phaser.Tilemaps.LayerData](../class/Phaser.Tilemaps.LayerData.md) - The corresponding `LayerData` within `this.layers`, or null.


> Source: [src/tilemaps/Tilemap.js#L1247](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1247)  
Since: 3.0.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| layer | string \| number | [Phaser.Tilemaps.TilemapLayer](../class/Phaser.Tilemaps.TilemapLayer.md) | Yes | The name of the layer from Tiled, the index of the layer in the map or a Tilemap Layer. If not given will default to the map's current layer index. |


**Returns:** number - The LayerData index within this.layers.


> Source: [src/tilemaps/Tilemap.js#L1302](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1302)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L1337](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1337)  
Since: 3.0.0
...
**Returns:** [Phaser.Tilemaps.ObjectLayer](../class/Phaser.Tilemaps.ObjectLayer.md) - The corresponding `ObjectLayer` within `this.objects`, or null.


> Source: [src/tilemaps/Tilemap.js#L1264](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1264)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L1281](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1281)  
Since: 3.21.0
...
**Returns:** [Phaser.Tilemaps.Tile](../class/Phaser.Tilemaps.Tile.md) - Returns a Tile, or null if the layer given was invalid.


> Source: [src/tilemaps/Tilemap.js#L1353](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1353)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L1377](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1377)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L2548](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L2548)  
Since: 3.60.0
...
> Source: [src/tilemaps/Tilemap.js#L1402](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1402)  
Since: 3.21.0
...
**Returns:** [Phaser.Tilemaps.Tileset](../class/Phaser.Tilemaps.Tileset.md) - The Tileset, or `null` if no matching named tileset was found.


> Source: [src/tilemaps/Tilemap.js#L1501](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1501)  
Since: 3.14.0
...
> Source: [src/tilemaps/Tilemap.js#L1518](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1518)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L1423](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1423)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L1449](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1449)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L1474](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1474)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L1534](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1534)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L1558](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1558)  
Since: 3.0.0
...
**Returns:** [Phaser.Tilemaps.Tile](../class/Phaser.Tilemaps.Tile.md) - Returns a Tile, or null if the layer given was invalid or the coordinates were out of bounds.


> Source: [src/tilemaps/Tilemap.js#L1603](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1603)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L1633](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1633)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L1664](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1664)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L1697](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1697)  
Since: 3.0.0
...
**Returns:** [Phaser.Tilemaps.Tilemap](../class/Phaser.Tilemaps.Tilemap.md) - This Tilemap object.


> Source: [src/tilemaps/Tilemap.js#L1863](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1863)  
Since: 3.0.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| layer | string \| number | [Phaser.Tilemaps.TilemapLayer](../class/Phaser.Tilemaps.TilemapLayer.md) | Yes | The tile layer to be removed. |


**Returns:** [Phaser.Tilemaps.Tilemap](../class/Phaser.Tilemaps.Tilemap.md) - Returns this, or null if the layer given was invalid.


> Source: [src/tilemaps/Tilemap.js#L1785](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1785)  
Since: 3.17.0
...
| name | type | optional | default | description |
| ---- | ---- | -------- | ------- | ----------- |
| tiles | [Phaser.Tilemaps.Tile](../class/Phaser.Tilemaps.Tile.md) \| Array.\<[Phaser.Tilemaps.Tile](../class/Phaser.Tilemaps.Tile.md)> | No |  | The Tile to remove, or an array of Tiles. |
...
**Returns:** Array.\<[Phaser.Tilemaps.Tile](../class/Phaser.Tilemaps.Tile.md)> - Returns an array of Tiles that were removed.


> Source: [src/tilemaps/Tilemap.js#L1890](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1890)  
Since: 3.17.0
...
**Returns:** [Phaser.Tilemaps.Tile](../class/Phaser.Tilemaps.Tile.md) - Returns the Tile that was removed, or null if the layer given was invalid.


> Source: [src/tilemaps/Tilemap.js#L1930](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1930)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L1958](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1958)  
Since: 3.0.0
...
**Returns:** [Phaser.Tilemaps.Tilemap](../class/Phaser.Tilemaps.Tilemap.md) - Return this Tilemap object, or null if the layer given was invalid.


> Source: [src/tilemaps/Tilemap.js#L1987](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L1987)  
Since: 3.0.0
...
**Returns:** [Phaser.Tilemaps.Tilemap](../class/Phaser.Tilemaps.Tilemap.md) - This Tilemap instance.


> Source: [src/tilemaps/Tilemap.js#L2020](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L2020)  
Since: 3.17.0
...
> Source: [src/tilemaps/Tilemap.js#L2047](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L2047)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L2323](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L2323)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L2078](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L2078)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L2111](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L2111)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L2179](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L2179)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L2144](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L2144)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L2210](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L2210)  
Since: 3.0.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| layer | string \| number | [Phaser.Tilemaps.TilemapLayer](../class/Phaser.Tilemaps.TilemapLayer.md) | Yes | The name of the layer from Tiled, the index of the layer in the map or a TilemapLayer. If not given will default to the maps current layer index. |


**Returns:** [Phaser.Tilemaps.Tilemap](../class/Phaser.Tilemaps.Tilemap.md) - This Tilemap object.


> Source: [src/tilemaps/Tilemap.js#L2301](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L2301)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L2369](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L2369)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L324](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L324)  
Since: 3.12.0
...
> Source: [src/tilemaps/Tilemap.js#L2241](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L2241)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L2270](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L2270)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L2412](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L2412)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L2442](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L2442)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L2473](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L2473)  
Since: 3.0.0
...
| tileX | number | No | The x coordinate, in tiles, not pixels. |
| tileY | number | No | The y coordinate, in tiles, not pixels. |
| vec2 | [Phaser.Math.Vector2](../class/Phaser.Math.Vector2.md) | Yes | A Vector2 to store the coordinates in. If not given a new Vector2 is created. |
| camera | [Phaser.Cameras.Scene2D.Camera](../class/Phaser.Cameras.Scene2D.Camera.md) | Yes | The Camera to use when calculating the tile index from the world values. |
| layer | string \| number | [Phaser.Tilemaps.TilemapLayer](../class/Phaser.Tilemaps.TilemapLayer.md) | Yes | The tile layer to use. If not given the current layer is used. |


**Returns:** [Phaser.Math.Vector2](../class/Phaser.Math.Vector2.md) - Returns a Vector2, or null if the layer given was invalid.


> Source: [src/tilemaps/Tilemap.js#L2521](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L2521)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L2497](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L2497)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L2581](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L2581)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L2621](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L2621)  
Since: 3.0.0
...
**Returns:** [Phaser.Math.Vector2](../class/Phaser.Math.Vector2.md) - Returns a vec2, or null if the layer given was invalid.


> Source: [src/tilemaps/Tilemap.js#L2679](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L2679)  
Since: 3.0.0
...
> Source: [src/tilemaps/Tilemap.js#L2650](https://github.com/phaserjs/phaser/blob/v3.85.2/src/tilemaps/Tilemap.js#L2650)  
Since: 3.0.0
