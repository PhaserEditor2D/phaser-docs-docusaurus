...
seoDescription: Phaser v3.85.2 Documentation for Phaser.Curves.Spline
ogImage: 
---
...
| ---- | ---- | -------- | ----------- |
| points | Array.\<[Phaser.Math.Vector2](../class/Phaser.Math.Vector2.md)> \| Array.\<number> | Array.\<Array.\<number>> | Yes | The points that configure the curve. |
...
> Source: [src/curves/SplineCurve.js#L14](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/SplineCurve.js#L14)  
Since: 3.0.0
...
### points: Array.\<[Phaser.Math.Vector2](../class/Phaser.Math.Vector2.md)>
...
> Source: [src/curves/SplineCurve.js#L38](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/SplineCurve.js#L38)  
Since: 3.0.0
...
**Returns:** [Phaser.Math.Vector2](../class/Phaser.Math.Vector2.md) - The new Vector2 added to the curve


> Source: [src/curves/SplineCurve.js#L91](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/SplineCurve.js#L91)  
Since: 3.0.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| points | Array.\<[Phaser.Math.Vector2](../class/Phaser.Math.Vector2.md)> \| Array.\<number> | Array.\<Array.\<number>> | No | The points that configure the curve. |


**Returns:** [Phaser.Curves.Spline](../class/Phaser.Curves.Spline.md) - This curve object.


> Source: [src/curves/SplineCurve.js#L51](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/SplineCurve.js#L51)  
Since: 3.0.0
...
> Source: [src/curves/SplineCurve.js#L204](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/SplineCurve.js#L204)  
Since: 3.0.0
...
> Source: [src/curves/SplineCurve.js#L145](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/SplineCurve.js#L145)  
Since: 3.0.0
...
> Source: [src/curves/SplineCurve.js#L130](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/SplineCurve.js#L130)  
Since: 3.0.0
...
> Source: [src/curves/SplineCurve.js#L111](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/SplineCurve.js#L111)  
Since: 3.0.0
...
> Source: [src/curves/SplineCurve.js#L178](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/SplineCurve.js#L178)  
Since: 3.0.0
