...
seoDescription: Phaser v3.85.2 Documentation for Phaser.Curves.QuadraticBezier
ogImage: 
---
...
| ---- | ---- | -------- | ----------- |
| p0 | [Phaser.Math.Vector2](../class/Phaser.Math.Vector2.md) \| Array.\<number> | No | Start point, or an array of point pairs. |
...
> Source: [src/curves/QuadraticBezierCurve.js#L12](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/QuadraticBezierCurve.js#L12)  
Since: 3.2.0
...
> Source: [src/curves/QuadraticBezierCurve.js#L43](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/QuadraticBezierCurve.js#L43)  
Since: 3.2.0
...
> Source: [src/curves/QuadraticBezierCurve.js#L52](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/QuadraticBezierCurve.js#L52)  
Since: 3.2.0
...
> Source: [src/curves/QuadraticBezierCurve.js#L61](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/QuadraticBezierCurve.js#L61)  
Since: 3.2.0
...
| ---- | ---- | -------- | ------- | ----------- |
| graphics | [Phaser.GameObjects.Graphics](../class/Phaser.GameObjects.Graphics.md) | No |  | `Graphics` object to draw onto. |
...
**Returns:** [Phaser.GameObjects.Graphics](../class/Phaser.GameObjects.Graphics.md) - `Graphics` object that was drawn to.


> Source: [src/curves/QuadraticBezierCurve.js#L132](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/QuadraticBezierCurve.js#L132)  
Since: 3.2.0
...
> Source: [src/curves/QuadraticBezierCurve.js#L190](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/QuadraticBezierCurve.js#L190)  
Since: 3.2.0
...
> Source: [src/curves/QuadraticBezierCurve.js#L105](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/QuadraticBezierCurve.js#L105)  
Since: 3.2.0
...
> Source: [src/curves/QuadraticBezierCurve.js#L90](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/QuadraticBezierCurve.js#L90)  
Since: 3.2.0
...
> Source: [src/curves/QuadraticBezierCurve.js#L71](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/QuadraticBezierCurve.js#L71)  
Since: 3.2.0
...
> Source: [src/curves/QuadraticBezierCurve.js#L168](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/QuadraticBezierCurve.js#L168)  
Since: 3.2.0
