...
seoDescription: Phaser v3.85.2 Documentation for Phaser.Curves.Line
ogImage: 
---
...
| ---- | ---- | -------- | ----------- |
| p0 | [Phaser.Math.Vector2](../class/Phaser.Math.Vector2.md) \| Array.\<number> | No | The first endpoint. |
| p1 | [Phaser.Math.Vector2](../class/Phaser.Math.Vector2.md) | Yes | The second endpoint. |
...
> Source: [src/curves/LineCurve.js#L15](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/LineCurve.js#L15)  
Since: 3.0.0
...
> Source: [src/curves/LineCurve.js#L65](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/LineCurve.js#L65)  
Since: 3.0.0
...
> Source: [src/curves/LineCurve.js#L45](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/LineCurve.js#L45)  
Since: 3.0.0
...
> Source: [src/curves/LineCurve.js#L54](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/LineCurve.js#L54)  
Since: 3.0.0
...
> Source: [src/curves/LineCurve.js#L236](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/LineCurve.js#L236)  
Since: 3.0.0
...
> Source: [src/curves/LineCurve.js#L280](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/LineCurve.js#L280)  
Since: 3.0.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| out | [Phaser.Geom.Rectangle](../class/Phaser.Geom.Rectangle.md) | Yes | A Rectangle object to store the bounds in. If not given a new Rectangle will be created. |
...
> Source: [src/curves/LineCurve.js#L76](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/LineCurve.js#L76)  
Since: 3.0.0
...
> Source: [src/curves/LineCurve.js#L131](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/LineCurve.js#L131)  
Since: 3.0.0
...
> Source: [src/curves/LineCurve.js#L160](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/LineCurve.js#L160)  
Since: 3.0.0
...
> Source: [src/curves/LineCurve.js#L114](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/LineCurve.js#L114)  
Since: 3.0.0
...
> Source: [src/curves/LineCurve.js#L95](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/LineCurve.js#L95)  
Since: 3.0.0
...
> Source: [src/curves/LineCurve.js#L178](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/LineCurve.js#L178)  
Since: 3.0.0
...
> Source: [src/curves/LineCurve.js#L200](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/LineCurve.js#L200)  
Since: 3.0.0
...
> Source: [src/curves/LineCurve.js#L259](https://github.com/phaserjs/phaser/blob/v3.85.2/src/curves/LineCurve.js#L259)  
Since: 3.0.0
