...
seoDescription: Phaser v3.85.2 Documentation for Phaser.Input.Keyboard.KeyboardPlugin
ogImage: 
---
...
See [http://www.html5gamedevs.com/topic/4876-impossible-to-use-more-than-2-keyboard-input-buttons-at-the-same-time/](http://www.html5gamedevs.com/topic/4876-impossible-to-use-more-than-2-keyboard-input-buttons-at-the-same-time/) for more details
and use the site [https://w3c.github.io/uievents/tools/key-event-viewer.html](https://w3c.github.io/uievents/tools/key-event-viewer.html) to test your n-key support in browser.
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L21](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L21)  
Since: 3.10.0
...
### combos: Array.\<[Phaser.Input.Keyboard.KeyCombo](../class/Phaser.Input.Keyboard.KeyCombo.md)>
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L142](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L142)  
Since: 3.10.0
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L122](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L122)  
Since: 3.10.0
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L77](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L77)  
Since: 3.16.0
...
### keys: Array.\<[Phaser.Input.Keyboard.Key](../class/Phaser.Input.Keyboard.Key.md)>
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L133](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L133)  
Since: 3.10.0
...
### manager: [Phaser.Input.Keyboard.KeyboardManager](../class/Phaser.Input.Keyboard.KeyboardManager.md)
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L113](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L113)  
Since: 3.16.0
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L86](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L86)  
Since: 3.10.0
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L104](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L104)  
Since: 3.10.0
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L95](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L95)  
Since: 3.10.0
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L151](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L151)  
Since: 3.50.0
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L161](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L161)  
Since: 3.50.0
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L171](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L171)  
Since: 3.50.1
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L927](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L927)  
Since: 3.11.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| keycode | string \| number | Array.\<number> | Array.\<any> | No | The Key Codes to enable event capture for. |


**Returns:** [Phaser.Input.Keyboard.KeyboardPlugin](../class/Phaser.Input.Keyboard.KeyboardPlugin.md) - This KeyboardPlugin object.


> Source: [src/input/keyboard/KeyboardPlugin.js#L243](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L243)  
Since: 3.16.0
...
| ---- | ---- | -------- | ------- | ----------- |
| key | [Phaser.Input.Keyboard.Key](../class/Phaser.Input.Keyboard.Key.md) \| string | number | No |  | Either a Key object, a string, such as `A` or `SPACE`, or a key code value. |
...
**Returns:** [Phaser.Input.Keyboard.Key](../class/Phaser.Input.Keyboard.Key.md) - The newly created Key object, or a reference to it if it already existed in the keys array.


> Source: [src/input/keyboard/KeyboardPlugin.js#L475](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L475)  
Since: 3.10.0
...
would return an object containing the properties (`up` and `down`) mapped to W and S [Phaser.Input.Keyboard.Key](../class/Phaser.Input.Keyboard.Key) objects.
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L413](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L413)  
Since: 3.10.0
...
**Returns:** [Phaser.Input.Keyboard.KeyboardPlugin](../class/Phaser.Input.Keyboard.KeyboardPlugin.md) - `this`.
...
| name | type | optional | default | description |
| ---- | ---- | -------- | ------- | ----------- |
| key | [Phaser.Input.Keyboard.Key](../class/Phaser.Input.Keyboard.Key.md) | No |  | A Key object. |
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L687](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L687)  
Since: 3.11.0
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L376](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L376)  
Since: 3.16.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| keys | string \| Array.\<number> | Array.\<object> | No | The keys that comprise this combo. |
| config | [Phaser.Types.Input.Keyboard.KeyComboConfig](../typedef/Phaser.Types.Input.Keyboard.md#KeyComboConfig) | Yes | A Key Combo configuration object. |


**Returns:** [Phaser.Input.Keyboard.KeyCombo](../class/Phaser.Input.Keyboard.KeyCombo.md) - The new KeyCombo object.


> Source: [src/input/keyboard/KeyboardPlugin.js#L645](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L645)  
Since: 3.10.0
...
**Returns:** [Phaser.Types.Input.Keyboard.CursorKeys](../typedef/Phaser.Types.Input.Keyboard.md#CursorKeys) - An object containing the properties: `up`, `down`, `left`, `right`, `space` and `shift`.


> Source: [src/input/keyboard/KeyboardPlugin.js#L393](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L393)  
Since: 3.10.0
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L360](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L360)  
Since: 3.16.0
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L344](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L344)  
Since: 3.16.0
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L331](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L331)  
Since: 3.16.0
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L230](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L230)  
Since: 3.10.0
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L604](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L604)  
Since: 3.24.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| keycode | string \| number | Array.\<number> | Array.\<any> | No | The Key Codes to disable event capture for. |


**Returns:** [Phaser.Input.Keyboard.KeyboardPlugin](../class/Phaser.Input.Keyboard.KeyboardPlugin.md) - This KeyboardPlugin object.


> Source: [src/input/keyboard/KeyboardPlugin.js#L289](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L289)  
Since: 3.16.0
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L541](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L541)  
Since: 3.10.0
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L840](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L840)  
Since: 3.15.0
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L185](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L185)  
Since: 3.10.0
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L895](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L895)  
Since: 3.10.0
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L869](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L869)  
Since: 3.10.0
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L209](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L209)  
Since: 3.10.0
...
> Source: [src/input/keyboard/KeyboardPlugin.js#L724](https://github.com/phaserjs/phaser/blob/v3.85.2/src/input/keyboard/KeyboardPlugin.js#L724)  
Since: 3.10.0
