...
Scope: 
static
> Source: [src/geom/mesh/index.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/geom/mesh/index.js#L7)  


# Static functions

- [Face](../class/geom-mesh-face)
- [Vertex](../class/geom-mesh-vertex)
# Static functions
