...
Scope: 
static
> Source: [src/physics/matter-js/components/Collision.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/physics/matter-js/components/Collision.js#L7)  
Since: 3.0.0
