---
visibility: public
slug: namespace/textures-parsers
title: Phaser.Textures.Parsers

seoTitle: Phaser.Textures.Parsers
...
Scope: 
static
> Source: [src/textures/parsers/index.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/textures/parsers/index.js#L7)  
...
**Returns:** [Phaser.Types.Textures.CompressedTextureData](../typedef/Phaser.Types.Textures.md#CompressedTextureData) - The Compressed Texture data.


> Source: [src/textures/parsers/KTXParser.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/textures/parsers/KTXParser.js#L7)  
Since: 3.60.0
...
> Source: [src/textures/parsers/PVRParser.js#L236](https://github.com/phaserjs/phaser/blob/v3.85.2/src/textures/parsers/PVRParser.js#L236)  
Since: 3.60.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| data | [Phaser.Types.Textures.CompressedTextureData](../typedef/Phaser.Types.Textures.md#CompressedTextureData) | No | The compressed texture data to verify. |


**Returns:** boolean - Whether the compressed texture data is valid.


> Source: [src/textures/parsers/VerifyCompressedTexture.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/textures/parsers/VerifyCompressedTexture.js#L9)  
Since: 3.80.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| texture | [Phaser.Textures.Texture](../class/Phaser.Textures.Texture.md) | No | The Texture to add the Frames to. |
| sourceIndex | number | No | The index of the TextureSource. |
| xml | * | No | The XML data. |


**Returns:** [Phaser.Textures.Texture](../class/Phaser.Textures.Texture.md) - The Texture modified by this parser.


> Source: [src/textures/parsers/AtlasXML.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/textures/parsers/AtlasXML.js#L7)  
Since: 3.7.0
...
> Source: [src/textures/parsers/Canvas.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/textures/parsers/Canvas.js#L7)  
Since: 3.0.0
...
> Source: [src/textures/parsers/Image.js#L7](https://github.com/phaserjs/phaser/blob/v3.85.2/src/textures/parsers/Image.js#L7)  
Since: 3.0.0
...
> Source: [src/textures/parsers/JSONArray.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/textures/parsers/JSONArray.js#L9)  
Since: 3.0.0
...
> Source: [src/textures/parsers/JSONHash.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/textures/parsers/JSONHash.js#L9)  
Since: 3.0.0
...
> Source: [src/textures/parsers/SpriteSheet.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/textures/parsers/SpriteSheet.js#L9)  
Since: 3.0.0
...
| ---- | ---- | -------- | ------- | ----------- |
| texture | [Phaser.Textures.Texture](../class/Phaser.Textures.Texture.md) | No |  | The Texture to add the Frames to. |
| frame | [Phaser.Textures.Frame](../class/Phaser.Textures.Frame.md) | No |  | The Frame that contains the Sprite Sheet. |
| config | object | No |  | An object describing how to parse the Sprite Sheet. |
| config.frameWidth | number | No |  | Width in pixels of a single frame in the sprite sheet. |
| config.frameHeight | number | Yes |  | Height in pixels of a single frame in the sprite sheet. Defaults to frameWidth if not provided. |
...
> Source: [src/textures/parsers/SpriteSheetFromAtlas.js#L9](https://github.com/phaserjs/phaser/blob/v3.85.2/src/textures/parsers/SpriteSheetFromAtlas.js#L9)  
Since: 3.0.0
...
For more details about Sprite Meta Data see [https://docs.unity3d.com/ScriptReference/SpriteMetaData.html](https://docs.unity3d.com/ScriptReference/SpriteMetaData.html)
...
> Source: [src/textures/parsers/UnityYAML.js#L38](https://github.com/phaserjs/phaser/blob/v3.85.2/src/textures/parsers/UnityYAML.js#L38)  
Since: 3.0.0
