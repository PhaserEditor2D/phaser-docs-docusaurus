---
visibility: public
slug: typedef/types-core
title: Types.Core
description: Phaser.Types.Core
seoTitle: Types.Core
seoDescription: Phaser v3.86.0 Documentation for Phaser.Types.Core
ogImage: 
---
...
> Source: [src/core/typedefs/AudioConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/core/typedefs/AudioConfig.js#L1)  
Since: 3.0.0
...
**Member of**: Phaser.Types.Core
> Source: [src/core/typedefs/BannerConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/core/typedefs/BannerConfig.js#L1)  
Since: 3.0.0
...
**Member of**: Phaser.Types.Core
> Source: [src/core/typedefs/BootCallback.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/core/typedefs/BootCallback.js#L1)  
Since: 3.0.0
...
| name | type | optional | default | description |
| ---- | ---- | -------- | ------- | ----------- |
| preBoot | [Phaser.Types.Core.BootCallback](../typedef/Phaser.Types.Core.md#BootCallback) | Yes | "Phaser.Types.Core.NOOP" | A function to run at the start of the boot sequence. |
| postBoot | [Phaser.Types.Core.BootCallback](../typedef/Phaser.Types.Core.md#BootCallback) | Yes | "Phaser.Types.Core.NOOP" | A function to run at the end of the boot sequence. At this point, all the game systems have started and plugins have been loaded. |

**Type**: object

**Member of**: Phaser.Types.Core
> Source: [src/core/typedefs/CallbacksConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/core/typedefs/CallbacksConfig.js#L1)  
Since: 3.0.0
...
**Member of**: Phaser.Types.Core
> Source: [src/core/typedefs/DOMContainerConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/core/typedefs/DOMContainerConfig.js#L1)  
Since: 3.12.0
...
**Member of**: Phaser.Types.Core
> Source: [src/core/typedefs/FPSConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/core/typedefs/FPSConfig.js#L1)  
Since: 3.0.0
...
| parent | HTMLElement \| string | null | Yes |  | The DOM element that will contain the game canvas, or its `id`. If undefined, or if the named element doesn't exist, the game canvas is appended to the document body. If `null` no parent will be used and you are responsible for adding the canvas to the dom. |
...
| scene | [Phaser.Types.Scenes.SceneType](../typedef/Phaser.Types.Scenes.md#SceneType) \| Array.\<[Phaser.Types.Scenes.SceneType](../typedef/Phaser.Types.Scenes.md#SceneType)> | Yes | null | A scene or scenes to add to the game. If several are given, the first is started; the remainder are started only if they have `{ active: true }`. See the `sceneConfig` argument in `Phaser.Scenes.SceneManager#add`. |
...
| input | boolean \| [Phaser.Types.Core.InputConfig](../typedef/Phaser.Types.Core.md#InputConfig) | Yes |  | Input configuration, or `false` to disable all game input. |
...
| banner | boolean \| [Phaser.Types.Core.BannerConfig](../typedef/Phaser.Types.Core.md#BannerConfig) | Yes | false | Configuration for the banner printed in the browser console when the game starts. |
| dom | [Phaser.Types.Core.DOMContainerConfig](../typedef/Phaser.Types.Core.md#DOMContainerConfig) | Yes |  | The DOM Container configuration object. |
| fps | [Phaser.Types.Core.FPSConfig](../typedef/Phaser.Types.Core.md#FPSConfig) | Yes |  | Game loop configuration. |
| render | [Phaser.Types.Core.RenderConfig](../typedef/Phaser.Types.Core.md#RenderConfig) | Yes |  | Game renderer configuration. |
| callbacks | [Phaser.Types.Core.CallbacksConfig](../typedef/Phaser.Types.Core.md#CallbacksConfig) | Yes |  | Optional callbacks to run before or after game boot. |
| loader | [Phaser.Types.Core.LoaderConfig](../typedef/Phaser.Types.Core.md#LoaderConfig) | Yes |  | Loader configuration. |
| images | [Phaser.Types.Core.ImagesConfig](../typedef/Phaser.Types.Core.md#ImagesConfig) | Yes |  | Images configuration. |
| physics | [Phaser.Types.Core.PhysicsConfig](../typedef/Phaser.Types.Core.md#PhysicsConfig) | Yes |  | Physics configuration. |
| plugins | [Phaser.Types.Core.PluginObject](../typedef/Phaser.Types.Core.md#PluginObject) \| Array.\<[Phaser.Types.Core.PluginObjectItem](../typedef/Phaser.Types.Core.md#PluginObjectItem)> | Yes |  | Plugins to install. |
| scale | [Phaser.Types.Core.ScaleConfig](../typedef/Phaser.Types.Core.md#ScaleConfig) | Yes |  | The Scale Manager configuration. |
| audio | [Phaser.Types.Core.AudioConfig](../typedef/Phaser.Types.Core.md#AudioConfig) | Yes |  | The Audio Configuration object. |
| pipeline | [Phaser.Types.Core.PipelineConfig](../typedef/Phaser.Types.Core.md#PipelineConfig) | Yes |  | The WebGL Pipeline configuration object. Can also be part of the `RenderConfig`. |
...
| batchSize | number | Yes | 4096 | The default WebGL batch size. Represents the number of _quads_ that can be added to a single batch. |
...
| mode | [Phaser.Scale.ScaleModeType](../typedef/Phaser.Scale.md#ScaleModeType) | Yes | "Phaser.Scale.ScaleModes.NONE" | The scale mode. |
...
| autoCenter | [Phaser.Scale.CenterType](../typedef/Phaser.Scale.md#CenterType) | Yes | "Phaser.Scale.Center.NO_CENTER" | Automatically center the canvas within the parent? |
...
**Member of**: Phaser.Types.Core
> Source: [src/core/typedefs/GameConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/core/typedefs/GameConfig.js#L1)  
Since: 3.0.0
...
**Member of**: Phaser.Types.Core
> Source: [src/core/typedefs/GamepadInputConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/core/typedefs/GamepadInputConfig.js#L1)  
Since: 3.0.0
...
| ---- | ---- | -------- | ----------- |
| default | string \| undefined | null | Yes | A base64 encoded image file to use as the 'default' texture. |
| missing | string \| undefined | null | Yes | A base64 encoded image file to use as the 'missing' texture. |
| white | string \| undefined | null | Yes | A base64 encoded image file to use as the 'white' texture. |

**Type**: object

**Member of**: Phaser.Types.Core
> Source: [src/core/typedefs/ImagesConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/core/typedefs/ImagesConfig.js#L1)  
Since: 3.0.0
...
| name | type | optional | default | description |
| ---- | ---- | -------- | ------- | ----------- |
| keyboard | boolean \| [Phaser.Types.Core.KeyboardInputConfig](../typedef/Phaser.Types.Core.md#KeyboardInputConfig) | Yes | true | Keyboard input configuration. `true` uses the default configuration and `false` disables keyboard input. |
| mouse | boolean \| [Phaser.Types.Core.MouseInputConfig](../typedef/Phaser.Types.Core.md#MouseInputConfig) | Yes | true | Mouse input configuration. `true` uses the default configuration and `false` disables mouse input. |
| touch | boolean \| [Phaser.Types.Core.TouchInputConfig](../typedef/Phaser.Types.Core.md#TouchInputConfig) | Yes | true | Touch input configuration. `true` uses the default configuration and `false` disables touch input. |
| gamepad | boolean \| [Phaser.Types.Core.GamepadInputConfig](../typedef/Phaser.Types.Core.md#GamepadInputConfig) | Yes | false | Gamepad input configuration. `true` enables gamepad input. |
...
**Member of**: Phaser.Types.Core
> Source: [src/core/typedefs/InputConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/core/typedefs/InputConfig.js#L1)  
Since: 3.0.0
...
**Member of**: Phaser.Types.Core
> Source: [src/core/typedefs/KeyboardInputConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/core/typedefs/KeyboardInputConfig.js#L1)  
Since: 3.0.0
...
**Member of**: Phaser.Types.Core
> Source: [src/core/typedefs/LoaderConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/core/typedefs/LoaderConfig.js#L1)  
Since: 3.0.0
...
**Member of**: Phaser.Types.Core
> Source: [src/core/typedefs/MouseInputConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/core/typedefs/MouseInputConfig.js#L1)  
Since: 3.0.0
...
**Member of**: Phaser.Types.Core
> Source: [src/core/typedefs/NOOP.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/core/typedefs/NOOP.js#L1)  
Since: 3.0.0
...
| arcade | [Phaser.Types.Physics.Arcade.ArcadeWorldConfig](../typedef/Phaser.Types.Physics.Arcade.md#ArcadeWorldConfig) | Yes | Arcade Physics configuration. |
| matter | [Phaser.Types.Physics.Matter.MatterWorldConfig](../typedef/Phaser.Types.Physics.Matter.md#MatterWorldConfig) | Yes | Matter Physics configuration. |

**Type**: object

**Member of**: Phaser.Types.Core
> Source: [src/core/typedefs/PhysicsConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/core/typedefs/PhysicsConfig.js#L1)  
Since: 3.0.0
...
**Type**: Array.\<[Phaser.Renderer.WebGL.WebGLPipeline](../class/Phaser.Renderer.WebGL.WebGLPipeline.md)>, object.\<string, [Phaser.Renderer.WebGL.WebGLPipeline](../class/Phaser.Renderer.WebGL.WebGLPipeline.md)>

**Member of**: Phaser.Types.Core
> Source: [src/core/typedefs/PipelineConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/core/typedefs/PipelineConfig.js#L1)  
Since: 3.50.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| global | Array.\<[Phaser.Types.Core.PluginObjectItem](../typedef/Phaser.Types.Core.md#PluginObjectItem)> | Yes | Global plugins to install. |
| scene | Array.\<[Phaser.Types.Core.PluginObjectItem](../typedef/Phaser.Types.Core.md#PluginObjectItem)> | Yes | Scene plugins to install. |
...
**Member of**: Phaser.Types.Core
> Source: [src/core/typedefs/PluginObject.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/core/typedefs/PluginObject.js#L1)  
Since: 3.8.0
...
**Member of**: Phaser.Types.Core
> Source: [src/core/typedefs/PluginObjectItem.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/core/typedefs/PluginObjectItem.js#L1)  
Since: 3.8.0
...
| pipeline | [Phaser.Types.Core.PipelineConfig](../typedef/Phaser.Types.Core.md#PipelineConfig) | Yes |  | The WebGL Pipeline configuration object. |
| autoMobilePipeline | boolean | Yes | true | Automatically enable the Mobile Pipeline if iOS or Android detected? |
| defaultPipeline | string | Yes | "'MultiPipeline'" | The WebGL Pipeline that Game Objects will use by default. Set to 'MultiPipeline' as standard. |
...
**Member of**: Phaser.Types.Core
> Source: [src/core/typedefs/RenderConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/core/typedefs/RenderConfig.js#L1)  
Since: 3.0.0
...
| zoom | [Phaser.Scale.ZoomType](../typedef/Phaser.Scale.md#ZoomType) \| number | Yes | 1 | The zoom value of the game canvas. |
...
**Member of**: Phaser.Types.Core
> Source: [src/core/typedefs/ScaleConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/core/typedefs/ScaleConfig.js#L1)  
Since: 3.16.0
...
**Member of**: Phaser.Types.Core
> Source: [src/core/typedefs/TimeStepCallback.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/core/typedefs/TimeStepCallback.js#L1)  
Since: 3.0.0
...
**Member of**: Phaser.Types.Core
> Source: [src/core/typedefs/TouchInputConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/core/typedefs/TouchInputConfig.js#L1)  
Since: 3.0.0
...
**Member of**: Phaser.Types.Core
> Source: [src/core/typedefs/WidthHeight.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/core/typedefs/WidthHeight.js#L1)  
Since: 3.16.0
