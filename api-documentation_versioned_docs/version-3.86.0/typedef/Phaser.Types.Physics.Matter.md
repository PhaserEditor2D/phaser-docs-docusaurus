---
visibility: public
slug: typedef/types-physics-matter
title: Types.Physics.Matter
description: Phaser.Types.Physics.Matter
seoTitle: Types.Physics.Matter
seoDescription: Phaser v3.86.0 Documentation for Phaser.Types.Physics.Matter
ogImage: 
---
...
**Type**: MatterJS.BodyType | [Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md) | [Phaser.Physics.Matter.Image](../class/Phaser.Physics.Matter.Image.md) | [Phaser.Physics.Matter.Sprite](../class/Phaser.Physics.Matter.Sprite.md) | [Phaser.Physics.Matter.TileBody](../class/Phaser.Physics.Matter.TileBody.md)

**Member of**: Phaser.Types.Physics.Matter
> Source: [src/physics/matter-js/typedefs/MatterBody.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/matter-js/typedefs/MatterBody.js#L1)  
Since: 3.22.0
...
| shape | string \| [Phaser.Types.Physics.Matter.MatterSetBodyConfig](../typedef/Phaser.Types.Physics.Matter.md#MatterSetBodyConfig) | Yes | null | Set this Game Object to create and use a new Body based on the configuration object given. |
...
| vertices | Array.\<[Phaser.Types.Math.Vector2Like](../typedef/Phaser.Types.Math.md#Vector2Like)> | Yes | null | An array of `Vector` objects that specify the convex hull of the rigid body. These should be provided about the origin `(0, 0)`. |
| position | [Phaser.Types.Math.Vector2Like](../typedef/Phaser.Types.Math.md#Vector2Like) | Yes |  | A `Vector` that specifies the current world-space position of the body. |
| force | [Phaser.Types.Math.Vector2Like](../typedef/Phaser.Types.Math.md#Vector2Like) | Yes |  | A `Vector` that specifies the force to apply in the current step. It is zeroed after every `Body.update`. See also `Body.applyForce`. |
...
| collisionFilter | [Phaser.Types.Physics.Matter.MatterCollisionFilter](../typedef/Phaser.Types.Physics.Matter.md#MatterCollisionFilter) | Yes |  | An `Object` that specifies the collision filtering properties of this body. |
...
| chamfer | number \| Array.\<number> | [Phaser.Types.Physics.Matter.MatterChamferConfig](../typedef/Phaser.Types.Physics.Matter.md#MatterChamferConfig) | Yes | null | A number, or array of numbers, to chamfer the vertices of the body, or a full Chamfer configuration object. |
...
| scale | [Phaser.Types.Math.Vector2Like](../typedef/Phaser.Types.Math.md#Vector2Like) | Yes |  | A `Vector` that specifies the initial scale of the body. |
| gravityScale | [Phaser.Types.Math.Vector2Like](../typedef/Phaser.Types.Math.md#Vector2Like) | Yes |  | A `Vector` that scales the influence of World gravity when applied to this body. |
...
| render | [Phaser.Types.Physics.Matter.MatterBodyRenderConfig](../typedef/Phaser.Types.Physics.Matter.md#MatterBodyRenderConfig) | Yes |  | The Debug Render configuration object for this body. |
...
**Member of**: Phaser.Types.Physics.Matter
> Source: [src/physics/matter-js/typedefs/MatterBodyConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/matter-js/typedefs/MatterBodyConfig.js#L1)  
Since: 3.22.0
...
**Member of**: Phaser.Types.Physics.Matter
> Source: [src/physics/matter-js/typedefs/MatterBodyRenderConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/matter-js/typedefs/MatterBodyRenderConfig.js#L1)  
Since: 3.22.0
...
**Member of**: Phaser.Types.Physics.Matter
> Source: [src/physics/matter-js/typedefs/MatterBodyTileOptions.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/matter-js/typedefs/MatterBodyTileOptions.js#L1)  
Since: 3.0.0
...
**Member of**: Phaser.Types.Physics.Matter
> Source: [src/physics/matter-js/typedefs/MatterChamferConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/matter-js/typedefs/MatterChamferConfig.js#L1)  
Since: 3.22.0
...
**Member of**: Phaser.Types.Physics.Matter
> Source: [src/physics/matter-js/typedefs/MatterCollisionData.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/matter-js/typedefs/MatterCollisionData.js#L1)  
Since: 3.22.0
...
**Member of**: Phaser.Types.Physics.Matter
> Source: [src/physics/matter-js/typedefs/MatterCollisionFilter.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/matter-js/typedefs/MatterCollisionFilter.js#L1)  
Since: 3.22.0
...
| collision | [Phaser.Types.Physics.Matter.MatterCollisionData](../typedef/Phaser.Types.Physics.Matter.md#MatterCollisionData) | No | The collision data object. |
| inverseMass | number | No | The resulting inverse mass from the collision. |
| friction | number | No | The resulting friction from the collision. |
| frictionStatic | number | No | The resulting static friction from the collision. |
| restitution | number | No | The resulting restitution from the collision. |
...
**Member of**: Phaser.Types.Physics.Matter
> Source: [src/physics/matter-js/typedefs/MatterCollisionPair.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/matter-js/typedefs/MatterCollisionPair.js#L1)  
Since: 3.22.0
...
| pointA | [Phaser.Types.Math.Vector2Like](../typedef/Phaser.Types.Math.md#Vector2Like) | Yes |  | A `Vector` that specifies the offset of the constraint from center of the `constraint.bodyA` if defined, otherwise a world-space position. |
| pointB | [Phaser.Types.Math.Vector2Like](../typedef/Phaser.Types.Math.md#Vector2Like) | Yes |  | A `Vector` that specifies the offset of the constraint from center of the `constraint.bodyB` if defined, otherwise a world-space position. |
...
| plugin | any | Yes |  | An object reserved for storing plugin-specific properties. |
| render | [Phaser.Types.Physics.Matter.MatterConstraintRenderConfig](../typedef/Phaser.Types.Physics.Matter.md#MatterConstraintRenderConfig) | Yes |  | The Debug Render configuration object for this constraint. |

**Type**: object

**Member of**: Phaser.Types.Physics.Matter
> Source: [src/physics/matter-js/typedefs/MatterConstraintConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/matter-js/typedefs/MatterConstraintConfig.js#L1)  
Since: 3.22.0
...
**Member of**: Phaser.Types.Physics.Matter
> Source: [src/physics/matter-js/typedefs/MatterConstraintRenderConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/matter-js/typedefs/MatterConstraintRenderConfig.js#L1)  
Since: 3.22.0
...
**Member of**: Phaser.Types.Physics.Matter
> Source: [src/physics/matter-js/typedefs/MatterDebugConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/matter-js/typedefs/MatterDebugConfig.js#L1)  
Since: 3.22.0
...
| fps | number | Yes | 60 | A number that specifies the frame rate in seconds. If you don't specify this, but do specify `delta`, those values set the fps rate. |
...
| deltaSampleSize | number | Yes | 60 | The size of the delta smoothing array when `isFixed` is `false`. |
| delta | number | Yes | 16.666 | A number that specifies the time step between updates in milliseconds. If you set the `fps` property, this value is set based on that. If `isFixed` is set to `true`, then `delta` is fixed. If it is `false`, then `delta` can dynamically change to maintain the correct apparent simulation speed. |
...
**Member of**: Phaser.Types.Physics.Matter
> Source: [src/physics/matter-js/typedefs/MatterRunnerConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/matter-js/typedefs/MatterRunnerConfig.js#L1)  
Since: 3.22.0
...
**Member of**: Phaser.Types.Physics.Matter
> Source: [src/physics/matter-js/typedefs/MatterSetBodyConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/matter-js/typedefs/MatterSetBodyConfig.js#L1)  
Since: 3.22.0
...
**Member of**: Phaser.Types.Physics.Matter
> Source: [src/physics/matter-js/typedefs/MatterTileOptions.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/matter-js/typedefs/MatterTileOptions.js#L1)  
Since: 3.0.0
...
**Member of**: Phaser.Types.Physics.Matter
> Source: [src/physics/matter-js/typedefs/MatterWalls.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/matter-js/typedefs/MatterWalls.js#L1)  
Since: 3.0.0
...
| name | type | optional | default | description |
| ---- | ---- | -------- | ------- | ----------- |
| gravity | [Phaser.Types.Math.Vector2Like](../typedef/Phaser.Types.Math.md#Vector2Like) | Yes |  | Sets {@link Phaser.Physics.Matter.World#gravity}. |
...
| debug | boolean \| [Phaser.Types.Physics.Matter.MatterDebugConfig](../typedef/Phaser.Types.Physics.Matter.md#MatterDebugConfig) | Yes | false | Controls the Matter Debug Rendering options. If a boolean it will use the default values, otherwise, specify a Debug Config object. |
| runner | [Phaser.Types.Physics.Matter.MatterRunnerConfig](../typedef/Phaser.Types.Physics.Matter.md#MatterRunnerConfig) | Yes |  | Sets the Matter Runner options. |

**Type**: object

**Member of**: Phaser.Types.Physics.Matter
> Source: [src/physics/matter-js/typedefs/MatterWorldConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/matter-js/typedefs/MatterWorldConfig.js#L1)  
Since: 3.0.0
