...
seoDescription: Phaser v3.86.0 Documentation for Phaser.Types.Create
ogImage: 
---
...
> Source: [src/create/typedefs/GenerateTextureConfig.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/create/typedefs/GenerateTextureConfig.js#L1)  
Since: 3.0.0
...
| palette | [Phaser.Types.Create.Palette](../typedef/Phaser.Types.Create.md#Palette) | Yes | "Arne16" | The indexed palette that the data cell values map to. |
...
| preRender | [Phaser.Types.Create.GenerateTextureCallback](../typedef/Phaser.Types.Create.md#GenerateTextureCallback) | Yes |  | A callback to send the canvas to prior to the texture being drawn. |
| postRender | [Phaser.Types.Create.GenerateTextureCallback](../typedef/Phaser.Types.Create.md#GenerateTextureCallback) | Yes |  | A callback to send the canvas to after the texture has been drawn. |

**Type**: object

**Member of**: Phaser.Types.Create
> Source: [src/create/typedefs/GenerateTextureConfig.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/create/typedefs/GenerateTextureConfig.js#L9)  
Since: 3.0.0
...
**Member of**: Phaser.Types.Create
> Source: [src/create/typedefs/Palette.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/create/typedefs/Palette.js#L1)  
Since: 3.0.0
