...
seoDescription: Phaser v3.86.0 Documentation for Phaser.Types.Sound
ogImage: 
---
...
| source | [Phaser.Types.Sound.SpatialSoundConfig](../typedef/Phaser.Types.Sound.md#SpatialSoundConfig) | Yes | null | An optional config object containing default spatial sound settings. |
...
| config | [Phaser.Types.Sound.SoundConfig](../typedef/Phaser.Types.Sound.md#SoundConfig) | Yes |  | An optional config object containing default marker settings. |
...
| distanceModel | 'linear' \| 'inverse' | 'exponential' | Yes | "'inverse'" | Which algorithm to use to reduce the volume of the audio source as it moves away from the listener. Possible values are "linear", "inverse" and "exponential". The default value is "inverse". |
...
| follow | [Phaser.Types.Math.Vector2Like](../typedef/Phaser.Types.Math.md#Vector2Like) | Yes |  | Set this Sound object to automatically track the x/y position of this object. Can be a Phaser Game Object, Vec2 or anything that exposes public x/y properties. |
