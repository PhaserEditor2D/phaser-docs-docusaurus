---
visibility: public
slug: function/physics
title: Phaser.Physics

seoTitle: Phaser.Physics
seoDescription: Phaser v3.86.0 Documentation for Phaser.Physics
ogImage: 
---
...
> Source: [src/physics/arcade/components/OverlapCirc.js#L6](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/components/OverlapCirc.js#L6)  
Since: 3.21.0
...
> Source: [src/physics/arcade/components/OverlapRect.js#L1](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/components/OverlapRect.js#L1)  
Since: 3.17.0
...
> Source: [src/physics/arcade/GetCollidesWith.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/GetCollidesWith.js#L7)  
Since: 3.70.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| body1 | [Phaser.Physics.Arcade.Body](../class/Phaser.Physics.Arcade.Body.md) | No | The first Body to separate. |
| body2 | [Phaser.Physics.Arcade.Body](../class/Phaser.Physics.Arcade.Body.md) | No | The second Body to separate. |
...
> Source: [src/physics/arcade/GetOverlapX.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/GetOverlapX.js#L9)  
Since: 3.0.0
...
> Source: [src/physics/arcade/GetOverlapY.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/GetOverlapY.js#L9)  
Since: 3.0.0
...
> Source: [src/physics/arcade/SeparateX.js#L10](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/SeparateX.js#L10)  
Since: 3.0.0
...
> Source: [src/physics/arcade/SeparateY.js#L10](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/SeparateY.js#L10)  
Since: 3.0.0
...
| data | [Phaser.Types.Physics.Arcade.ArcadeBodyCollision](../typedef/Phaser.Types.Physics.Arcade.md#ArcadeBodyCollision) | Yes | The collision data object to populate, or create if not given. |


**Returns:** [Phaser.Types.Physics.Arcade.ArcadeBodyCollision](../typedef/Phaser.Types.Physics.Arcade.md#ArcadeBodyCollision) - The collision data.


> Source: [src/physics/arcade/SetCollisionObject.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/SetCollisionObject.js#L7)  
Since: 3.70.0
...
> Source: [src/physics/arcade/ProcessX.js#L25](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/ProcessX.js#L25)  
Since: 3.50.0
...
> Source: [src/physics/arcade/ProcessX.js#L71](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/ProcessX.js#L71)  
Since: 3.50.0
...
> Source: [src/physics/arcade/ProcessX.js#L118](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/ProcessX.js#L118)  
Since: 3.50.0
...
> Source: [src/physics/arcade/ProcessX.js#L169](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/ProcessX.js#L169)  
Since: 3.50.0
...
> Source: [src/physics/arcade/ProcessX.js#L331](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/ProcessX.js#L331)  
Since: 3.50.0
...
> Source: [src/physics/arcade/ProcessX.js#L367](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/ProcessX.js#L367)  
Since: 3.50.0
...
> Source: [src/physics/arcade/ProcessY.js#L25](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/ProcessY.js#L25)  
Since: 3.50.0
...
> Source: [src/physics/arcade/ProcessY.js#L71](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/ProcessY.js#L71)  
Since: 3.50.0
...
> Source: [src/physics/arcade/ProcessY.js#L118](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/ProcessY.js#L118)  
Since: 3.50.0
...
> Source: [src/physics/arcade/ProcessY.js#L169](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/ProcessY.js#L169)  
Since: 3.50.0
...
> Source: [src/physics/arcade/ProcessY.js#L331](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/ProcessY.js#L331)  
Since: 3.50.0
...
> Source: [src/physics/arcade/ProcessY.js#L367](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/ProcessY.js#L367)  
Since: 3.50.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| tile | [Phaser.Tilemaps.Tile](../class/Phaser.Tilemaps.Tile.md) | No | The Tile to process. |
| sprite | [Phaser.GameObjects.Sprite](../class/Phaser.GameObjects.Sprite.md) | No | The Game Object to process with the Tile. |


**Returns:** boolean - The result of the callback, `true` for further processing, or `false` to skip this pair.


> Source: [src/physics/arcade/tilemap/ProcessTileCallbacks.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/tilemap/ProcessTileCallbacks.js#L7)  
Since: 3.0.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| body | [Phaser.Physics.Arcade.Body](../class/Phaser.Physics.Arcade.Body.md) | No | The Body object to separate. |
| x | number | No | The x separation amount. |


> Source: [src/physics/arcade/tilemap/ProcessTileSeparationX.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/tilemap/ProcessTileSeparationX.js#L7)  
Since: 3.0.0
...
> Source: [src/physics/arcade/tilemap/ProcessTileSeparationY.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/tilemap/ProcessTileSeparationY.js#L7)  
Since: 3.0.0
...
| body | [Phaser.Physics.Arcade.Body](../class/Phaser.Physics.Arcade.Body.md) | No | The Body object to separate. |
| tile | [Phaser.Tilemaps.Tile](../class/Phaser.Tilemaps.Tile.md) | No | The tile to collide against. |
| tileWorldRect | [Phaser.Geom.Rectangle](../class/Phaser.Geom.Rectangle.md) | No | A rectangle-like object defining the dimensions of the tile. |
| tilemapLayer | [Phaser.Tilemaps.TilemapLayer](../class/Phaser.Tilemaps.TilemapLayer.md) | No | The tilemapLayer to collide against. |
...
> Source: [src/physics/arcade/tilemap/SeparateTile.js#L11](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/tilemap/SeparateTile.js#L11)  
Since: 3.0.0
...
| ---- | ---- | -------- | ----------- |
| body | [Phaser.Physics.Arcade.Body](../class/Phaser.Physics.Arcade.Body.md) | No | The Body object to separate. |
| tile | [Phaser.Tilemaps.Tile](../class/Phaser.Tilemaps.Tile.md) | No | The tile to check. |
...
> Source: [src/physics/arcade/tilemap/TileCheckX.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/tilemap/TileCheckX.js#L9)  
Since: 3.0.0
...
> Source: [src/physics/arcade/tilemap/TileCheckY.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/tilemap/TileCheckY.js#L9)  
Since: 3.0.0
...
| body | [Phaser.Physics.Arcade.Body](../class/Phaser.Physics.Arcade.Body.md) | No | The body to check for intersection against. |


**Returns:** boolean - Returns `true` of the tile intersects with the body, otherwise `false`.


> Source: [src/physics/arcade/tilemap/TileIntersectsBody.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/arcade/tilemap/TileIntersectsBody.js#L7)  
Since: 3.0.0
...
> Source: [src/physics/matter-js/MatterGameObject.js#L26](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/matter-js/MatterGameObject.js#L26)  
Since: 3.3.0
...
> Source: [src/physics/matter-js/PhysicsJSONParser.js#L53](https://github.com/phaserjs/phaser/blob/v3.86.0/src/physics/matter-js/PhysicsJSONParser.js#L53)  
Since: 3.22.0
