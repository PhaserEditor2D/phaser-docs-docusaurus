...
Scope: 
static
> Source: [src/create/index.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/create/index.js#L7)  
...
> Source: [src/create/GenerateTexture.js#L11](https://github.com/phaserjs/phaser/blob/v3.86.0/src/create/GenerateTexture.js#L11)  
Since: 3.0.0
...
- [Palettes](../namespace/create-palettes)
