---
visibility: public
slug: namespace/actions
title: Phaser.Actions

seoTitle: Phaser.Actions
...
Scope: 
static
> Source: [src/actions/index.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/index.js#L7)  
...
| ---- | ---- | -------- | ------- | ----------- |
| items | array \| Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> | No |  | The array of items to be updated by this action. |
...
**Returns:** array, Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> - The array of objects that were passed to this Action.


> Source: [src/actions/AlignTo.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/AlignTo.js#L9)  
Since: 3.22.0
...
> Source: [src/actions/Angle.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/Angle.js#L9)  
Since: 3.0.0
...
| ---- | ---- | -------- | ----------- |
| items | array \| Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> | No | The array of items to be updated by this action. |
| callback | [Phaser.Types.Actions.CallCallback](../typedef/Phaser.Types.Actions.md#CallCallback) | No | The callback to be invoked. It will be passed just one argument: the item from the array. |
| context | * | No | The scope in which the callback will be invoked. |


**Returns:** array, Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> - The array of objects that was passed to this Action.


> Source: [src/actions/Call.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/Call.js#L7)  
Since: 3.0.0
...
| name | type | optional | default | description |
| ---- | ---- | -------- | ------- | ----------- |
| items | array \| Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> | No |  | The array of items to be searched by this action. |
| compare | object | No |  | The comparison object. Each property in this object will be checked against the items of the array. |
| index | number | Yes | 0 | An optional offset to start searching from within the items array. |


**Returns:** object, [Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md) - The first object in the array that matches the comparison object, or `null` if no match was found.


> Source: [src/actions/GetFirst.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/GetFirst.js#L7)  
Since: 3.0.0
...
**Returns:** object, [Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md) - The last object in the array that matches the comparison object, or `null` if no match was found.


> Source: [src/actions/GetLast.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/GetLast.js#L7)  
Since: 3.3.0
...
| ---- | ---- | -------- | ----------- |
| items | array \| Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> | No | The array of items to be updated by this action. |
| options | [Phaser.Types.Actions.GridAlignConfig](../typedef/Phaser.Types.Actions.md#GridAlignConfig) | No | The GridAlign Configuration object. |


**Returns:** array, Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> - The array of objects that were passed to this Action.


> Source: [src/actions/GridAlign.js#L15](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/GridAlign.js#L15)  
Since: 3.0.0
...
> Source: [src/actions/IncAlpha.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/IncAlpha.js#L9)  
Since: 3.0.0
...
> Source: [src/actions/IncX.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/IncX.js#L9)  
Since: 3.0.0
...
> Source: [src/actions/IncXY.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/IncXY.js#L9)  
Since: 3.0.0
...
> Source: [src/actions/IncY.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/IncY.js#L9)  
Since: 3.0.0
...
| name | type | optional | default | description |
| ---- | ---- | -------- | ------- | ----------- |
| items | array \| Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> | No |  | An array of Game Objects. The contents of this array are updated by this Action. |
| circle | [Phaser.Geom.Circle](../class/Phaser.Geom.Circle.md) | No |  | The Circle to position the Game Objects on. |
...
**Returns:** array, Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> - The array of Game Objects that was passed to this Action.


> Source: [src/actions/PlaceOnCircle.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/PlaceOnCircle.js#L7)  
Since: 3.0.0
...
| ---- | ---- | -------- | ------- | ----------- |
| items | array \| Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> | No |  | An array of Game Objects. The contents of this array are updated by this Action. |
| ellipse | [Phaser.Geom.Ellipse](../class/Phaser.Geom.Ellipse.md) | No |  | The Ellipse to position the Game Objects on. |
| startAngle | number | Yes | 0 | Optional angle to start position from, in radians. |
| endAngle | number | Yes | 6.28 | Optional angle to stop position at, in radians. |
...
> Source: [src/actions/PlaceOnEllipse.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/PlaceOnEllipse.js#L7)  
Since: 3.0.0
...
| ---- | ---- | -------- | ----------- |
| items | array \| Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> | No | An array of Game Objects. The contents of this array are updated by this Action. |
| line | [Phaser.Geom.Line](../class/Phaser.Geom.Line.md) | No | The Line to position the Game Objects on. |
...
> Source: [src/actions/PlaceOnLine.js#L10](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/PlaceOnLine.js#L10)  
Since: 3.0.0
...
| ---- | ---- | -------- | ------- | ----------- |
| items | array \| Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> | No |  | An array of Game Objects. The contents of this array are updated by this Action. |
| rect | [Phaser.Geom.Rectangle](../class/Phaser.Geom.Rectangle.md) | No |  | The Rectangle to position the Game Objects on. |
...
> Source: [src/actions/PlaceOnRectangle.js#L11](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/PlaceOnRectangle.js#L11)  
Since: 3.0.0
...
| ---- | ---- | -------- | ------- | ----------- |
| items | array \| Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> | No |  | An array of Game Objects. The contents of this array are updated by this Action. |
| triangle | [Phaser.Geom.Triangle](../class/Phaser.Geom.Triangle.md) | No |  | The Triangle to position the Game Objects on. |
...
> Source: [src/actions/PlaceOnTriangle.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/PlaceOnTriangle.js#L9)  
Since: 3.0.0
...
> Source: [src/actions/PlayAnimation.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/PlayAnimation.js#L7)  
Since: 3.0.0
...
> Source: [src/actions/PropertyValueInc.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/PropertyValueInc.js#L7)  
Since: 3.3.0
...
> Source: [src/actions/PropertyValueSet.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/PropertyValueSet.js#L7)  
Since: 3.3.0
...
| ---- | ---- | -------- | ----------- |
| items | array \| Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> | No | An array of Game Objects. The contents of this array are updated by this Action. |
| circle | [Phaser.Geom.Circle](../class/Phaser.Geom.Circle.md) | No | The Circle to position the Game Objects within. |


**Returns:** array, Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> - The array of Game Objects that was passed to this Action.


> Source: [src/actions/RandomCircle.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/RandomCircle.js#L9)  
Since: 3.0.0
...
| ---- | ---- | -------- | ----------- |
| items | array \| Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> | No | An array of Game Objects. The contents of this array are updated by this Action. |
| ellipse | [Phaser.Geom.Ellipse](../class/Phaser.Geom.Ellipse.md) | No | The Ellipse to position the Game Objects within. |


**Returns:** array, Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> - The array of Game Objects that was passed to this Action.


> Source: [src/actions/RandomEllipse.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/RandomEllipse.js#L9)  
Since: 3.0.0
...
| ---- | ---- | -------- | ----------- |
| items | array \| Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> | No | An array of Game Objects. The contents of this array are updated by this Action. |
| line | [Phaser.Geom.Line](../class/Phaser.Geom.Line.md) | No | The Line to position the Game Objects randomly on. |


**Returns:** array, Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> - The array of Game Objects that was passed to this Action.


> Source: [src/actions/RandomLine.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/RandomLine.js#L9)  
Since: 3.0.0
...
| ---- | ---- | -------- | ----------- |
| items | array \| Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> | No | An array of Game Objects. The contents of this array are updated by this Action. |
| rect | [Phaser.Geom.Rectangle](../class/Phaser.Geom.Rectangle.md) | No | The Rectangle to position the Game Objects within. |


**Returns:** array, Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> - The array of Game Objects that was passed to this Action.


> Source: [src/actions/RandomRectangle.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/RandomRectangle.js#L9)  
Since: 3.0.0
...
| ---- | ---- | -------- | ----------- |
| items | array \| Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> | No | An array of Game Objects. The contents of this array are updated by this Action. |
| triangle | [Phaser.Geom.Triangle](../class/Phaser.Geom.Triangle.md) | No | The Triangle to position the Game Objects within. |


**Returns:** array, Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> - The array of Game Objects that was passed to this Action.


> Source: [src/actions/RandomTriangle.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/RandomTriangle.js#L9)  
Since: 3.0.0
...
> Source: [src/actions/Rotate.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/Rotate.js#L9)  
Since: 3.0.0
...
> Source: [src/actions/RotateAround.js#L10](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/RotateAround.js#L10)  
Since: 3.0.0
...
> Source: [src/actions/RotateAroundDistance.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/RotateAroundDistance.js#L9)  
Since: 3.0.0
...
> Source: [src/actions/ScaleX.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/ScaleX.js#L9)  
Since: 3.0.0
...
> Source: [src/actions/ScaleXY.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/ScaleXY.js#L9)  
Since: 3.0.0
...
> Source: [src/actions/ScaleY.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/ScaleY.js#L9)  
Since: 3.0.0
...
> Source: [src/actions/SetAlpha.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/SetAlpha.js#L9)  
Since: 3.0.0
...
| ---- | ---- | -------- | ------- | ----------- |
| items | array \| Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> | No |  | The array of items to be updated by this action. |
| value | [Phaser.BlendModes](../namespace/Phaser.BlendModes.md) \| string | number | No |  | The Blend Mode to be set. |
| index | number | Yes | 0 | An optional offset to start searching from within the items array. |
| direction | number | Yes | 1 | The direction to iterate through the array. 1 is from beginning to end, -1 from end to beginning. |
...
> Source: [src/actions/SetBlendMode.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/SetBlendMode.js#L9)  
Since: 3.0.0
...
> Source: [src/actions/SetDepth.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/SetDepth.js#L9)  
Since: 3.0.0
...
> Source: [src/actions/SetHitArea.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/SetHitArea.js#L7)  
Since: 3.0.0
...
> Source: [src/actions/SetOrigin.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/SetOrigin.js#L9)  
Since: 3.0.0
...
> Source: [src/actions/SetRotation.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/SetRotation.js#L9)  
Since: 3.0.0
...
> Source: [src/actions/SetScale.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/SetScale.js#L9)  
Since: 3.0.0
...
> Source: [src/actions/SetScaleX.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/SetScaleX.js#L9)  
Since: 3.0.0
...
> Source: [src/actions/SetScaleY.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/SetScaleY.js#L9)  
Since: 3.0.0
...
> Source: [src/actions/SetScrollFactor.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/SetScrollFactor.js#L9)  
Since: 3.21.0
...
> Source: [src/actions/SetScrollFactorX.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/SetScrollFactorX.js#L9)  
Since: 3.21.0
...
> Source: [src/actions/SetScrollFactorY.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/SetScrollFactorY.js#L9)  
Since: 3.21.0
...
> Source: [src/actions/SetTint.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/SetTint.js#L7)  
Since: 3.0.0
...
> Source: [src/actions/SetVisible.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/SetVisible.js#L9)  
Since: 3.0.0
...
> Source: [src/actions/SetX.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/SetX.js#L9)  
Since: 3.0.0
...
> Source: [src/actions/SetXY.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/SetXY.js#L9)  
Since: 3.0.0
...
> Source: [src/actions/SetY.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/SetY.js#L9)  
Since: 3.0.0
...
| name | type | optional | default | description |
| ---- | ---- | -------- | ------- | ----------- |
| items | Array.\<[Phaser.Types.Math.Vector2Like](../typedef/Phaser.Types.Math.md#Vector2Like)> \| Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> | No |  | An array of Game Objects, or objects with public x and y positions. The contents of this array are updated by this Action. |
...
| output | [Phaser.Types.Math.Vector2Like](../typedef/Phaser.Types.Math.md#Vector2Like) | Yes |  | An optional Vec2Like object to store the final position in. |


**Returns:** [Phaser.Types.Math.Vector2Like](../typedef/Phaser.Types.Math.md#Vector2Like) - The output vector.


> Source: [src/actions/ShiftPosition.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/ShiftPosition.js#L9)  
Since: 3.0.0
...
> Source: [src/actions/Shuffle.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/Shuffle.js#L9)  
Since: 3.0.0
...
> Source: [src/actions/SmootherStep.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/SmootherStep.js#L9)  
Since: 3.0.0
...
> Source: [src/actions/SmoothStep.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/SmoothStep.js#L9)  
Since: 3.0.0
...
**Returns:** array, Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> - The array of Game Objects that were passed to this Action.


> Source: [src/actions/Spread.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/Spread.js#L7)  
Since: 3.0.0
...
> Source: [src/actions/ToggleVisible.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/ToggleVisible.js#L7)  
Since: 3.0.0
...
| ---- | ---- | -------- | ------- | ----------- |
| items | array \| Array.\<[Phaser.GameObjects.GameObject](../class/Phaser.GameObjects.GameObject.md)> | No |  | An array of Game Objects. The contents of this array are updated by this Action. |
| rect | [Phaser.Geom.Rectangle](../class/Phaser.Geom.Rectangle.md) | No |  | The rectangle which the objects will be wrapped to remain within. |
...
> Source: [src/actions/WrapInRectangle.js#L10](https://github.com/phaserjs/phaser/blob/v3.86.0/src/actions/WrapInRectangle.js#L10)  
Since: 3.0.0
