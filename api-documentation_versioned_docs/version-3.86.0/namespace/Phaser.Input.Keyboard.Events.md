...
Scope: 
static
> Source: [src/input/keyboard/events/index.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/input/keyboard/events/index.js#L7)  
...
You can also listen for a specific key being pressed. See [``Keyboard.Events.KEY_DOWN``](Phaser.Input.Keyboard.Events#event:KEY_DOWN) for details.



Finally, you can create Key objects, which you can also listen for events from. See [``Keyboard.Events.DOWN``](Phaser.Input.Keyboard.Events#event:DOWN) for details.



_Note_: Many keyboards are unable to process certain combinations of keys due to hardware limitations known as ghosting.

Read [this article on ghosting]{@link [http://www.html5gamedevs.com/topic/4876-impossible-to-use-more-than-2-keyboard-input-buttons-at-the-same-time/](http://www.html5gamedevs.com/topic/4876-impossible-to-use-more-than-2-keyboard-input-buttons-at-the-same-time/)} for details.
...
> Source: [src/input/keyboard/events/ANY_KEY_DOWN_EVENT.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/input/keyboard/events/ANY_KEY_DOWN_EVENT.js#L7)  
Since: 3.0.0
...
> Source: [src/input/keyboard/events/ANY_KEY_UP_EVENT.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/input/keyboard/events/ANY_KEY_UP_EVENT.js#L7)  
Since: 3.0.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| keycombo | [Phaser.Input.Keyboard.KeyCombo](../class/Phaser.Input.Keyboard.KeyCombo.md) | No | The Key Combo object that was matched. |
...
> Source: [src/input/keyboard/events/COMBO_MATCH_EVENT.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/input/keyboard/events/COMBO_MATCH_EVENT.js#L7)  
Since: 3.0.0
...
You can also create a generic 'global' listener. See [``Keyboard.Events.ANY_KEY_DOWN``](Phaser.Input.Keyboard.Events#event:ANY_KEY_DOWN) for details.

**Parameters:**
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| key | [Phaser.Input.Keyboard.Key](../class/Phaser.Input.Keyboard.Key.md) | No | The Key object that was pressed. |
| event | KeyboardEvent | No | The native DOM Keyboard Event. You can inspect this to learn more about any modifiers, etc. |


> Source: [src/input/keyboard/events/DOWN_EVENT.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/input/keyboard/events/DOWN_EVENT.js#L7)  
Since: 3.0.0
...
> Source: [src/input/keyboard/events/KEY_DOWN_EVENT.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/input/keyboard/events/KEY_DOWN_EVENT.js#L7)  
Since: 3.0.0
...
You can also create a generic 'global' listener. See [``Keyboard.Events.ANY_KEY_UP``](Phaser.Input.Keyboard.Events#event:ANY_KEY_UP) for details.
...
> Source: [src/input/keyboard/events/KEY_UP_EVENT.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/input/keyboard/events/KEY_UP_EVENT.js#L7)  
Since: 3.0.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| key | [Phaser.Input.Keyboard.Key](../class/Phaser.Input.Keyboard.Key.md) | No | The Key object that was released. |
| event | KeyboardEvent | No | The native DOM Keyboard Event. You can inspect this to learn more about any modifiers, etc. |


> Source: [src/input/keyboard/events/UP_EVENT.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/input/keyboard/events/UP_EVENT.js#L7)  
Since: 3.0.0
