...
Scope: 
static
> Source: [src/tweens/builders/index.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/tweens/builders/index.js#L7)  
...
> Source: [src/tweens/builders/GetBoolean.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/tweens/builders/GetBoolean.js#L7)  
Since: 3.0.0
...
> Source: [src/tweens/builders/GetEaseFunction.js#L10](https://github.com/phaserjs/phaser/blob/v3.86.0/src/tweens/builders/GetEaseFunction.js#L10)  
Since: 3.0.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| interpolation | string \| function | null | No | The interpolation function to find. This can be either a string, or a custom function, or null. |


**Returns:** function - The interpolation function to use, or `null`.


> Source: [src/tweens/builders/GetInterpolationFunction.js#L18](https://github.com/phaserjs/phaser/blob/v3.86.0/src/tweens/builders/GetInterpolationFunction.js#L18)  
Since: 3.60.0
...
> Source: [src/tweens/builders/GetNewValue.js#L7](https://github.com/phaserjs/phaser/blob/v3.86.0/src/tweens/builders/GetNewValue.js#L7)  
Since: 3.0.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| config | [Phaser.Types.Tweens.TweenBuilderConfig](../typedef/Phaser.Types.Tweens.md#TweenBuilderConfig) | No | The configuration object of the Tween to get the properties from. |


**Returns:** Array.\<string> - An array of all the properties the tween will operate on.


> Source: [src/tweens/builders/GetProps.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/tweens/builders/GetProps.js#L9)  
Since: 3.0.0
...
> Source: [src/tweens/builders/GetTargets.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/tweens/builders/GetTargets.js#L9)  
Since: 3.0.0
...
> Source: [src/tweens/builders/GetValueOp.js#L42](https://github.com/phaserjs/phaser/blob/v3.86.0/src/tweens/builders/GetValueOp.js#L42)  
Since: 3.0.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| parent | [Phaser.Tweens.TweenManager](../class/Phaser.Tweens.TweenManager.md) | No | The owner of the new Tween. |
| config | [Phaser.Types.Tweens.NumberTweenBuilderConfig](../typedef/Phaser.Types.Tweens.md#NumberTweenBuilderConfig) | No | Configuration for the new Tween. |
| defaults | [Phaser.Types.Tweens.TweenConfigDefaults](../typedef/Phaser.Types.Tweens.md#TweenConfigDefaults) | No | Tween configuration defaults. |


**Returns:** [Phaser.Tweens.Tween](../class/Phaser.Tweens.Tween.md) - The new tween.


> Source: [src/tweens/builders/NumberTweenBuilder.js#L18](https://github.com/phaserjs/phaser/blob/v3.86.0/src/tweens/builders/NumberTweenBuilder.js#L18)  
Since: 3.0.0
...
| config | [Phaser.Types.Tweens.StaggerConfig](../typedef/Phaser.Types.Tweens.md#StaggerConfig) | Yes | A Stagger Configuration object. |


**Returns:** function - The stagger function.


> Source: [src/tweens/builders/StaggerBuilder.js#L11](https://github.com/phaserjs/phaser/blob/v3.86.0/src/tweens/builders/StaggerBuilder.js#L11)  
Since: 3.19.0
...
| ---- | ---- | -------- | ----------- |
| parent | [Phaser.Tweens.TweenManager](../class/Phaser.Tweens.TweenManager.md) | No | The owner of the new Tween. |
| config | [Phaser.Types.Tweens.TweenBuilderConfig](../typedef/Phaser.Types.Tweens.md#TweenBuilderConfig) \| object | No | Configuration for the new Tween. |
| defaults | [Phaser.Types.Tweens.TweenConfigDefaults](../typedef/Phaser.Types.Tweens.md#TweenConfigDefaults) | No | Tween configuration defaults. |
...
> Source: [src/tweens/builders/TweenBuilder.js#L21](https://github.com/phaserjs/phaser/blob/v3.86.0/src/tweens/builders/TweenBuilder.js#L21)  
Since: 3.0.0
...
| ---- | ---- | -------- | ----------- |
| parent | [Phaser.Tweens.TweenManager](../class/Phaser.Tweens.TweenManager.md) | No | The owner of the new Tween. |
| config | [Phaser.Types.Tweens.TweenChainBuilderConfig](../typedef/Phaser.Types.Tweens.md#TweenChainBuilderConfig) \| object | No | Configuration for the new Tween. |


**Returns:** [Phaser.Tweens.TweenChain](../class/Phaser.Tweens.TweenChain.md) - The new Tween Chain.


> Source: [src/tweens/builders/TweenChainBuilder.js#L15](https://github.com/phaserjs/phaser/blob/v3.86.0/src/tweens/builders/TweenChainBuilder.js#L15)  
Since: 3.60.0
