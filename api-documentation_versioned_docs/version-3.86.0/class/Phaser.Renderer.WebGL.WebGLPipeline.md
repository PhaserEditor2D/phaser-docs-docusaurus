...
seoDescription: Phaser v3.86.0 Documentation for Phaser.Renderer.WebGL.WebGLPipeline
ogImage: 
---
...
> Source: [src/renderer/webgl/WebGLPipeline.js#L18](https://github.com/phaserjs/phaser/blob/v3.86.0/src/renderer/webgl/WebGLPipeline.js#L18)  
Since: 3.0.0
