...
seoDescription: Phaser v3.86.0 Documentation for Phaser.Plugins.PluginManager
ogImage: 
---
...
| ---- | ---- | -------- | ----------- |
| game | [Phaser.Game](../class/Phaser.Game.md) | No | The game instance that owns this Plugin Manager. |
...
> Source: [src/plugins/PluginManager.js#L17](https://github.com/phaserjs/phaser/blob/v3.86.0/src/plugins/PluginManager.js#L17)  
Since: 3.0.0
...
> Source: [src/plugins/PluginManager.js#L68](https://github.com/phaserjs/phaser/blob/v3.86.0/src/plugins/PluginManager.js#L68)  
Since: 3.0.0
...
### plugins: Array.\<[Phaser.Types.Plugins.GlobalPlugin](../typedef/Phaser.Types.Plugins.md#GlobalPlugin)>
...
> Source: [src/plugins/PluginManager.js#L77](https://github.com/phaserjs/phaser/blob/v3.86.0/src/plugins/PluginManager.js#L77)  
Since: 3.8.0
...
> Source: [src/plugins/PluginManager.js#L87](https://github.com/phaserjs/phaser/blob/v3.86.0/src/plugins/PluginManager.js#L87)  
Since: 3.8.0
...
> Source: [src/plugins/PluginManager.js#L96](https://github.com/phaserjs/phaser/blob/v3.86.0/src/plugins/PluginManager.js#L96)  
Since: 3.8.0
...
> Source: [src/plugins/PluginManager.js#L106](https://github.com/phaserjs/phaser/blob/v3.86.0/src/plugins/PluginManager.js#L106)  
Since: 3.8.0
...
| name | type | optional | description |
| ---- | ---- | -------- | ----------- |
| sys | [Phaser.Scenes.Systems](../class/Phaser.Scenes.Systems.md) | No | The Scene Systems class to install all the plugins in to. |
| globalPlugins | array | No | An array of global plugins to install. |
| scenePlugins | array | No | An array of scene plugins to install. |


> Source: [src/plugins/PluginManager.js#L211](https://github.com/phaserjs/phaser/blob/v3.86.0/src/plugins/PluginManager.js#L211)  
Since: 3.8.0
...
> Source: [src/plugins/PluginManager.js#L126](https://github.com/phaserjs/phaser/blob/v3.86.0/src/plugins/PluginManager.js#L126)  
Since: 3.0.0
...
> Source: [src/plugins/PluginManager.js#L865](https://github.com/phaserjs/phaser/blob/v3.86.0/src/plugins/PluginManager.js#L865)  
Since: 3.8.0
...
**Returns:** [Phaser.Plugins.BasePlugin](../class/Phaser.Plugins.BasePlugin.md), function - The plugin, or `null` if no plugin was found matching the key.


> Source: [src/plugins/PluginManager.js#L643](https://github.com/phaserjs/phaser/blob/v3.86.0/src/plugins/PluginManager.js#L643)  
Since: 3.8.0
...
**Returns:** [Phaser.Plugins.BasePlugin](../class/Phaser.Plugins.BasePlugin.md) - A Plugin object


> Source: [src/plugins/PluginManager.js#L686](https://github.com/phaserjs/phaser/blob/v3.86.0/src/plugins/PluginManager.js#L686)  
Since: 3.8.0
...
> Source: [src/plugins/PluginManager.js#L310](https://github.com/phaserjs/phaser/blob/v3.86.0/src/plugins/PluginManager.js#L310)  
Since: 3.8.0
...
**Returns:** [Phaser.Types.Plugins.GlobalPlugin](../typedef/Phaser.Types.Plugins.md#GlobalPlugin) - The plugin entry.


> Source: [src/plugins/PluginManager.js#L500](https://github.com/phaserjs/phaser/blob/v3.86.0/src/plugins/PluginManager.js#L500)  
Since: 3.8.0
...
> Source: [src/plugins/PluginManager.js#L472](https://github.com/phaserjs/phaser/blob/v3.86.0/src/plugins/PluginManager.js#L472)  
Since: 3.8.0
...
**Returns:** [Phaser.Plugins.BasePlugin](../class/Phaser.Plugins.BasePlugin.md) - The plugin that was started, or `null` if `start` was false, or game isn't yet booted.


> Source: [src/plugins/PluginManager.js#L400](https://github.com/phaserjs/phaser/blob/v3.86.0/src/plugins/PluginManager.js#L400)  
Since: 3.8.0
...
| plugin | function | No |  | The plugin code. This should be the non-instantiated version. |
| mapping | string | Yes |  | If this plugin is injected into the Phaser.Scene class, this is the property key to use. |
| addToScene | [Phaser.Scene](../class/Phaser.Scene.md) | Yes |  | Optionally automatically add this plugin to the given Scene. |
| fromLoader | boolean | Yes | false | Is this being called by the Loader? |


> Source: [src/plugins/PluginManager.js#L329](https://github.com/phaserjs/phaser/blob/v3.86.0/src/plugins/PluginManager.js#L329)  
Since: 3.8.0
...
> Source: [src/plugins/PluginManager.js#L521](https://github.com/phaserjs/phaser/blob/v3.86.0/src/plugins/PluginManager.js#L521)  
Since: 3.8.0
...
| addToScene | [Phaser.Scene](../class/Phaser.Scene.md) | Yes | Optionally add this file type into the Loader Plugin owned by the given Scene. |


> Source: [src/plugins/PluginManager.js#L821](https://github.com/phaserjs/phaser/blob/v3.86.0/src/plugins/PluginManager.js#L821)  
Since: 3.8.0
...
> Source: [src/plugins/PluginManager.js#L743](https://github.com/phaserjs/phaser/blob/v3.86.0/src/plugins/PluginManager.js#L743)  
Since: 3.8.0
...
> Source: [src/plugins/PluginManager.js#L792](https://github.com/phaserjs/phaser/blob/v3.86.0/src/plugins/PluginManager.js#L792)  
Since: 3.19.0
...
> Source: [src/plugins/PluginManager.js#L702](https://github.com/phaserjs/phaser/blob/v3.86.0/src/plugins/PluginManager.js#L702)  
Since: 3.8.0
...
> Source: [src/plugins/PluginManager.js#L724](https://github.com/phaserjs/phaser/blob/v3.86.0/src/plugins/PluginManager.js#L724)  
Since: 3.8.0
...
**Returns:** [Phaser.Plugins.BasePlugin](../class/Phaser.Plugins.BasePlugin.md) - The plugin that was started, or `null` if invalid key given or plugin is already stopped.


> Source: [src/plugins/PluginManager.js#L538](https://github.com/phaserjs/phaser/blob/v3.86.0/src/plugins/PluginManager.js#L538)  
Since: 3.8.0
...
**Returns:** [Phaser.Plugins.PluginManager](../class/Phaser.Plugins.PluginManager.md) - The Plugin Manager.


> Source: [src/plugins/PluginManager.js#L615](https://github.com/phaserjs/phaser/blob/v3.86.0/src/plugins/PluginManager.js#L615)  
Since: 3.8.0
...
**Returns:** [Phaser.Plugins.BasePlugin](../class/Phaser.Plugins.BasePlugin.md) - The plugin that was started, or `null` if invalid key given.


> Source: [src/plugins/PluginManager.js#L578](https://github.com/phaserjs/phaser/blob/v3.86.0/src/plugins/PluginManager.js#L578)  
Since: 3.9.0
