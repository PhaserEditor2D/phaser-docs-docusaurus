...
seoDescription: Phaser v3.86.0 Documentation for Phaser.FX.Controller
ogImage: 
---
...
> Source: [src/fx/Controller.js#L9](https://github.com/phaserjs/phaser/blob/v3.86.0/src/fx/Controller.js#L9)  
Since: 3.60.0
