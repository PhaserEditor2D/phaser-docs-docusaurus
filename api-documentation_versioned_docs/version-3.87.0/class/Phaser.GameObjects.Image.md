...
seoDescription: Phaser v3.87.0 Documentation for Phaser.GameObjects.Image
ogImage: 
---
...
> Source: [src/gameobjects/image/Image.js#L12](https://github.com/phaserjs/phaser/blob/v3.87.0/src/gameobjects/image/Image.js#L12)  
Since: 3.0.0
