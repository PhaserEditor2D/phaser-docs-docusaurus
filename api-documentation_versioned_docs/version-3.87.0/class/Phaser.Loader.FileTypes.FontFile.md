...
seoDescription: Phaser v3.87.0 Documentation for Phaser.Loader.FileTypes.FontFile
ogImage: 
---
...
| key | string \| [Phaser.Types.Loader.FileTypes.FontFileConfig](../typedef/Phaser.Types.Loader.FileTypes.md#FontFileConfig) | No |  | The key to use for this file, or a file configuration object. |
