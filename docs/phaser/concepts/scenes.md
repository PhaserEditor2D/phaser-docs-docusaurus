...
slug: scenes
title: Scenes
description: A Guide to Phaser Scenes
seoTitle: A Guide to Phaser Scenes
seoDescription: A Guide to Phaser Scenes
---
...
* `cameras` : An optional [Camera configuration object](./cameras.md#create-cameras-from-json).
...
* `physics` : The physics configuration object for the Scene.
  ...
  * `arcade` : [Arcade Physics configuration](./physics/arcade.md#configuration).
  * `matter` : [Matter Physics configuration](./physics/matter.md#configuration).
...
These can be [mapped onto different property names](https://labs.phaser.io/edit.html?src=src\scenes\scene%20injection%20map.js) if you like.
