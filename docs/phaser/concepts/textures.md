...
slug: textures
title: Textures
description: A Guide to Phaser Textures and the Texture Manager
seoTitle: Textures
seoDescription: A Guide to Phaser Textures and the Texture Manager
---
...
- [Example: Get frame names from atlas texture](https://labs.phaser.io/edit.html?src=src/loader\texture%20atlas%20json\load%20texture%20atlas.js)
