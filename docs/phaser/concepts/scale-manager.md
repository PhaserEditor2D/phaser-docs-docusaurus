...
seoTitle: Scale Manager
seoDescription: Scale Manager
---
...
- `viewport` : The [Rectangle](./geometry.md#rectangle) of visible area.
- `camera` : The [camera](./cameras.md) this viewport is respond upon.
- `out` : The [Rectangle](./geometry.md#rectangle) of visible area.
