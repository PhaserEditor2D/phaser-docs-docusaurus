...
slug: blitter
title: Blitter
description: A Guide to the Phaser Blitter Game Object
seoTitle: Blitter
seoDescription: A Guide to the Phaser Blitter Game Object
---
...
- Get
  ...
  - `frame` : [Frame object](../textures.md#frames).
- Set
...
Support [postFX effects](../gameobjects/shader.md)
