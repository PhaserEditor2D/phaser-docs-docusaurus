...
visibility: public
slug: display-list
seoTitle: Display List
seoDescription: A Guide to the Phaser Display List to manage Game Object rendering order
title: Display List
description: A Guide to the Phaser Display List to manage Game Object rendering order
---
...
In Phaser 2 it was possible to add a Game Object as a child of another Game Object. They were, in effect, self-contained Display Lists. This is no longer the case in Phaser 3. The only Game Object in Phaser 3 that can have children is the [Container](../gameobjects.md#parent-containers) Game Object.
