...
slug: particles
title: Particles
description: A Guide to the Phaser Particle System
seoTitle: Particles
seoDescription: A Guide to the Phaser Particle System
---
...
- `blendMode` : See [blend mode](../display.md#blend-mode)
...
- `bounds` : `{x, y, w, h}`, or `{x, y, width, height}`, or [Rectangle](../geometry.md#rectangle).
...
- `anims` : One or more animations, or a configuration object.
  ...
  - Configuration object :
    ...
    - `anims` : One or more animations names, or Play Animation Config objects.
      - String
      - Array of string
      - [Animation config](../animations.md#add-animation)
      - Array of [Animation config](../animations.md#add-animation)
- `pickRandom` :
  - `true` : Whether frames should be assigned at random from `frames`. Default behavior.
- `quantity` : The number of consecutive particles that will receive each frame. Default value is `1`.
...
- Active particles overlaps with a Rectangle Geometry object or an Arcade Physics Body.
  ...
  - `target` :
    - A [Rectangle](../geometry.md#rectangle).
    - Arcade Physics Body.
...
- Gets a bounds Rectangle calculated from the bounds of all currently active Particles
  ...
  - `output` : The [Rectangle](../geometry.md#rectangle) to store the results in.
...
- `source` : Geom like [Circle](../geometry.md#circle), [Ellipse](../geometry.md#ellipse), [Rectangle](../geometry.md#rectangle),[Triangle](../geometry.md#triangle), [Polygon](../geometry.md#polygon), or [Path or Curve](../math.md#path), which has `getRandomPoint(point)` method
  - Custom zone
...
- `source` : Geom like [Circle](../geometry.md#circle), [Ellipse](../geometry.md#ellipse), [Rectangle](../geometry.md#rectangle),[Triangle](../geometry.md#triangle), [Polygon](../geometry.md#polygon), or [Path or Curve](../math.md#path), which has `getPoints(quantity, stepRate)` method
  - Custom edge
...
!!! note "quantity or stepRate"
    - Any geometry like [circle](../geometry.md#circle), [ellipse](../geometry.md#ellipse), [line](../geometry.md#line), [polygon](../geometry.md#polygon), [rectangle](../geometry.md#rectangle), [triangle](../geometry.md#triangle) source has *quantity*, or *stepRate*
    - [Curve](../math.md#curve) source has *quantity*, or *stepRate*
    - [Path](../math.md#path) source only has *quantity*
...
- `source` : Geom like [Circle](../geometry.md#circle), [Ellipse](../geometry.md#ellipse), [Rectangle](../geometry.md#rectangle),[Triangle](../geometry.md#triangle), [Polygon](../geometry.md#polygon)
  - Custom `source` :
...
- Add bounds
  ...
  - `x, y, width, height`, `{x, y, width, height}`, or `{x, y, w, h}`, or [Rectangle](../geometry.md#rectangle) : Bounds
  - `collideLeft`, `collideRight`, `collideTop`, `collideBottom` : Whether particles interact with the left/right/top/bottom edge of the bounds.
- Collide edges
...
- Bound rectangle
  ...
  - `rect` : [Rectangle](../geometry.md#rectangle)
