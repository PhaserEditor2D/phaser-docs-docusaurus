...
slug: bitmap-text
title: Bitmap Text
description: A Guide to creating and using Bitmap Text in Phaser
seoTitle: Bitmap Text
seoDescription: A Guide to creating and using Bitmap Text in Phaser
---
...
![image](assets/bitmapfont-example-texture.png)
...
* Load bitmap font from texture and xml configuration
  ...
  * Loaded texture also can be used for [Image](#load-bitmap-font), [Sprite](#load-bitmap-font), or [Arcade Image](../physics/arcade.md#image-object), [Arcade Sprite](../physics/arcade.md#sprite-object)
