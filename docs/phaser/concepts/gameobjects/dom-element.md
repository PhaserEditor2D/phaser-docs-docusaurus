...
slug: dom-element
title: Dom Element
description: A Guide to the Phaser DOM Element Game Object
seoTitle: Dom Element
seoDescription: A Guide to the Phaser DOM Element Game Object
---
...
- Add event handler
    ...
    Reference: [event emitter](../events.md#the-event-emitter)
- Remove listener
