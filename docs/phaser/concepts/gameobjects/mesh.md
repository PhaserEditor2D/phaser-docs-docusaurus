...
visibility: public
slug: mesh
seoTitle: Mesh Game Object
seoDescription: A Guide to the Phaser Mesh Game Object to render textured vertices
title: Mesh
description: A Guide to the Phaser Mesh Game Object to render textured vertices
---
...
1. Update [Graphics](./graphics.md) in `this.update()` method.
