...
slug: sprite
title: Sprite
description: A Guide to the Phaser Sprite Game Object
seoTitle: Sprite
seoDescription: A Guide to the Phaser Sprite Game Object
---
...
See [game object - texture](../gameobjects.md#texture)
...
`config` : See [Add animation section](../animations.md#add-animation).
...
- Get global [animation object](../animations.md#animation-object)

    ```javascript
    var anim = this.anims.get(key);
    ```

- Get private [animation object](../animations.md#animation-object)
...
See also [Global time scale](../animations.md#global-time-scale)
