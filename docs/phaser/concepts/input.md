...
slug: input
title: Input
description: A Guide to Handling Input in Phaser
seoTitle: Input
seoDescription: A Guide to Handling Input in Phaser
---
...
1. Set smooth factor. In [game configuration](./scenes.md#game-configuration)
...
Reference : [Properties of point](./geometry.md#point)
...
- Left sticks, right sticks
  ...
  - `leftStick`, `rightStick` : Read only [vector2](./math.md#Vector).
