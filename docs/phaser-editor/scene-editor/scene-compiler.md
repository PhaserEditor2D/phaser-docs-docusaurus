...
We recommend you to read the [Code Editor](../code-editor/intro) chapter.
...
The **Open Output File** command opens the generated file in a new [Code Editor](../code-editor/intro), in the traditional way.
...
The **Quick Edit Output File** command (bound to the `Q` key) opens the generated file in a [Code Editor](../code-editor/intro) that is embedded in a modal dialog. This way is perfect for quick modifications, however, intellisense and all the other [Monaco editor](https://microsoft.github.io/monaco-editor/) features are enabled, so you have a similar experience in comparison with the traditional way of editing.
