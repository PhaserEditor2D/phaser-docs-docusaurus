...
This chapter covers in-depth the Scene Editor tools and concepts, if you want a quick tutorial to create a scene, read the [First steps chapter](../first-steps/download-and-install).
