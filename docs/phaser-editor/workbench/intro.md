...
![Workbench overview](https://cdn.phaser.io/editor-docs/workbench-overview-20241005.webp)
...
* The [Main toolbar](../workbench/main-toolbar) and [Main menu](../workbench/main-menu) provides commands (or actions) that affect the current editor or the whole IDE.
