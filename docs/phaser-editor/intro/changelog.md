...
[Release notes](https://phaser.io/news/2025/03/phaser-editor-4110-released)
...
[Release notes](https://phaser.io/news/2025/03/phaser-editor-4100-released)
...
[Release notes](https://phaser.io/news/2025/02/phaser-editor-490-released)
...
[Release notes](https://phaser.io/news/2024/12/phaser-editor-481-released)
...
* [#53](https://github.com/phaserjs/phaser-editor-issues/issues/52) Compiler's JavaScript output is adding redundant lines of code.
* [#54](https://github.com/phaserjs/phaser-editor-issues/issues/54) Adds support to `quality` and `distance` parameters in Glow FX object.
* [#58](https://github.com/phaserjs/phaser-editor-issues/issues/58) Adds Blend Mode support.
* [#55](https://github.com/phaserjs/phaser-editor-issues/issues/55) (Fix) Arrow keys in Outline view move the selected objects.
* [#21](https://github.com/phaserjs/phaser-editor-issues/issues/21) A command to open the OS Terminal.
* [#26](https://github.com/phaserjs/phaser-editor-issues/issues/26) Delete files operation now send the files to the recycle bin (Desktop edition).
* [#33](https://github.com/phaserjs/phaser-editor-issues/issues/33) Adds the "visible" parameter to the Asset Pack editor. Allows hide/show assets in the scene tools.
* [#2](https://github.com/phaserjs/phaser-editor-issues/issues/2) Fixes scene editor grid rendering when the browser has a huge zoom in factor.

## v4.7.1 - Dec 2, 2024

[Release notes](https://phaser.io/news/2024/11/phaser-editor-v470-released)

* [#50](https://github.com/phaserjs/phaser-editor-issues/issues/50) Fixes tilemap layer serialization inside a layer or container. 
...
* [#49](https://github.com/phaserjs/phaser-editor-issues/issues/49) Fixes tilemap accidental deletion on depth order operation.
* Updates internal editors to Phaser 3.87.
* Adds Font loader support to Asset Pack and Scene Editor.

## 4.6.1 - Nov 10, 2024

[Release notes](https://phaser.io/news/2024/11/phaser-editor-v460-released)
...
* [#44](https://github.com/phaserjs/phaser-editor-issues/issues/44) Adds sprite animation support to ArcadeSprite objects.
* [#46](https://github.com/phaserjs/phaser-editor-issues/issues/46) Adds resolution property to Text object.
* [#43](https://github.com/phaserjs/phaser-editor-issues/issues/43) Updates all help links to the new help website.

## v4.5.1 - Oct 13, 2024

[Release notes](https://phaser.io/news/2024/10/phaser-editor-451-released)
...
* [#41](https://github.com/phaserjs/phaser-editor-issues/issues/41) Fixes variable name generation.

## v4.5.0 - Sep 26, 2024

[Release notes](https://phaser.io/news/2024/09/phaser-editor-v45-released)
...
[Release notes](https://phaser.io/news/2024/09/phaser-editor-v44-released)
...
[Release notes](https://phaser.io/news/2024/09/phaser-editor-v43-released)
...
* [30](https://github.com/phaserjs/phaser-editor-issues/issues/30) Fixes duplicate command of script nodes and containers.
...
[Release notes](https://phaser.io/news/2024/08/phaser-editor-v420-released)
...
* [#24](https://github.com/phaserjs/phaser-editor-issues/issues/24) Passing polygon points in `super()` call.
* [#23](https://github.com/phaserjs/phaser-editor-issues/issues/23) Starting Dev Server with Vite configuration on Mac.
* [#29](https://github.com/phaserjs/phaser-editor-issues/issues/29) Workbench: fixed set snapping to object size command.
...
[Release notes](https://phaser.io/news/2024/07/phaser-editor-v410-released)
...
* [#7](https://github.com/phaserjs/phaser-editor-issues/issues/7) Adds support to more audio formats.
* Logs all server and desktop messages and errors to `server.log` and `desktop.log`.
* Server: adds support to WEBP image support.
* [[#1](https://github.com/phaserjs/phaser-editor/issues/1)] Fixes bad layout in Inspector view when imports multiple images.
...
[Release notes](https://phaser.io/news/2024/05/phaser-editor-v402-released)

* Moves the Scene Editor context menu's option "Layout -> Show Layout Tools" to "Tools -> Show In-Scene Tools".
...
* [#1](https://github.com/phaserjs/phaser-editor-issues/issues/1) Fixed compatibility issues with v3 configuration files and the `-max-number-files` flag.

## v4.0.1 - May 4, 3034

* Updates the link to the issues repo in the welcome page.
* [#3](https://github.com/phaserjs/phaser-editor-issues/issues/3) Fixes confirm dialog in Windows 11.
...
* Shows welcome page.
* [#314](https://github.com/PhaserEditor2D/PhaserEditor2D-v3/issues/314): (Fix) Pasting multiple script nodes changes their ordering.
* [#316](https://github.com/PhaserEditor2D/PhaserEditor2D-v3/issues/251): (Fix) Hides user component in prefab instance.
