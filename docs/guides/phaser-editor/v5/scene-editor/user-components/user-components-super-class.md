---
slug: user-components-super-class
title: A base class for your components
---
...
For this reason, we created a **UserComponent** class that you can use as the base class for all your components. This class is included in the [phasereditor2d-scripts-core](https://github.com/phaserjs/editor-scripts-core) library and should be included in your project if you created it with a Phaser Editor project template.

[Learn more about script libraries](../script-node/script-node-libraries)
...
![Context menu for creating the UserComponent.js file.](https://cdn.phaser.io/editor-docs/scene-editor-user-components-create-base-class-file-04012021.webp)
