---
slug: script-node-basic-scripts-project
title: The Core scripts project
---

In the previous section, we covered how to create the `ScriptNode` class. It is very basic, it is the minimum you need for using the script nodes. For that reason, we created a project with other basic script nodes you can use in your game: the [scripts-core](http://github.com/phaserjs/editor-scripts-core) project.
...
[github.com/PhaserEditor2D/scripts-core](http://github.com/phaserjs/editor-scripts-core)
